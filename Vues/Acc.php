                        ...
                        <main id="main" >
                            ...
                            <div class="page-grid" >
                              ...
                              <form method="post" enctype="multipart/form-data" >
                                ...
                                <input type="text" class="form-control" style="width:300px;" placeholder="" autofocus name="login" value="<?php echo $_SESSION['login'] ?>">
                                </div>
                                <br>
                                <label>Ancien mot de passe</label> 
                                <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-shield"></i></span>
                                <input type="password" class="form-control" style="width:300px;" placeholder="" autofocus  name="Amdp" readonly="true" value="<?php echo $_SESSION['motdepasse'] ?>">
                                </div><br>
                                <label>Nouveau mot de passe</label> 
                                <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-shield"></i></span>
                                <input type="text" class="form-control" style="width:300px;" placeholder="" autofocus  name="Nmdp1">
                                </div><br>
                                <label>Retaper le nouveau mot de passe</label> 
                                <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-shield"></i></span>
                                <input type="text" class="form-control" style="width:300px;" placeholder="" autofocus  name="Nmdp2">
                                </div>
                                <br>
                               ...
                               if($user->exist_user($_POST['login']) | $_POST['login']==$_SESSION['login']){
                                if ( (!empty($_POST['login'])) && (!empty($_POST['Nmdp1'])) && (!empty($_POST['Nmdp2'])) && ($_POST['Nmdp1']==$_POST['Nmdp2'])  ) {
                               $user->modif_user($_SESSION['login'],$_POST['login'],$_POST['Nmdp1']);  
                               session_destroy();
                               header("location:index.php");
                                }
                               }
                               if($user->exist_user($_POST['login'])==false && $_POST['login']!=$_SESSION['login']){?>
                               <br>
                    ...
                    <div id="sidebar" class="sidebar">
                        <div id="widget-area">
                            <aside class="widget widget_linklist">
                                <ul>
                                    <li  class="active"><a href="acc.php" class="btn btn-gray fullwidth text-left">votre Profil</a></li>
                                    ...
                                    <?php if($_SESSION['type']=='chercheur' ){?> 
                                     <li><a href="res2.php" class="btn btn-gray fullwidth text-left">Réservations</a></li>
                                    <?php } ?>
