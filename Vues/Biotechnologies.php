...
<head>
    ...
    <title>CIME | Biotechnologies</title>
</head>
                ...
                <ul class="nav text-uppercase">
                   <li><a href="index.php">Accueil</a></li>
                    ...
                    <li class="menu-item-has-children">
                        ...
                        <ul class="sub-menu">
                            <li><a href="conceptphp">Conception et test</a></li>
            ...
            <div class="sub-wrapper">
                ...
                <div class="breadcrumb-container clearfix">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="Biotechnologies.php">Présentation</a></li>
                    </ul>
                </div><!-- /breadcrumb -->
            </div><!-- /sub-wrapper -->
        </div><!-- /container -->
            ...
            <div class="row">
                <div class="col-md-9 col-md-push-3 col-sm-12 col-xs-12">
                    <div id="content" class="site-content">
                        <main id="main">
                            <h2 class="section-header">Biotechnologies</h2>
                            <div class="work-slider mb-20">
                                <img src="img/work/bio1.jpg" alt="" />
                                <img src="img/work/bio2.jpg" alt="" />
                                <img src="img/work/bio3.jpg" alt="" />
                                <img src="img/work/bio4.jpg" alt="" />
                                <img src="img/work/bio5.jpg" alt="" />
                            </div><!-- /work-slider -->

                            <div class="work-item-slider-wrapper">
                                <div class="work-item-slider">
                                    <a href="#"><img src="img/work/thumb/bio1.jpg" alt="" /></a>
                                    <a href="#"><img src="img/work/thumb/bio2.jpg" alt="" /></a>
                                    <a href="#"><img src="img/work/thumb/bio3.jpg" alt="" /></a>
                                    <a href="#"><img src="img/work/thumb/bio4.jpg" alt="" /></a>
                                    <a href="#"><img src="img/work/thumb/bio5.jpg" alt="" /></a>
                                </div><!-- /work-slider -->
                            ...
                            <div class="page-grid">
                                ...
                                <div class="page-content col-8">
                                    ...
                                    <p>Cette plateforme permet d’enseigner les techniques de base des biotechnologies et de préparer les matériels biologiques nécessaires aux travaux pratiques. Cet espace est constitué d’une salle de biologie moléculaire, d’une salle de culture cellulaire, d’une salle de préparation et de culture bactérienne, d’une salle d’instrumentation équipée de trois postes de microscopie. <br>
                                    L’enseignement des biotechnologies au Centre Interuniversitaire de Grenoble a débuté en 2002, par la mise en place d’un TP destiné à l’enseignement des biopuces ADN. La plateforme offre donc la possibilité de réaliser des biopuces à façon sur des supports de verre ou silicium, grâce à un robot de dépôt BioRobotics, et de détecter l’hybridation d’ADN cible par fluorescence. Cet outil a été utilisé par de très nombreux étudiants (ENSPG, Nanotech, ESONN, UFR de Pharmacie) pour réaliser toutes les étapes de la fabrication et de la validation d’une biopuce ADN.</p>
                                    <br />
                                    <p>Le transfert du CIME Nanotech sur le site de Minatec s’est accompagné d’une extension des activités en biotechnologies. Une plateforme complète et autonome a été construite et installée pour l’enseignement. En pratique, il est possible de cultiver sur place des cellules procaryotes et eucaryotes, de les observer au microscope optique, et d’extraire et analyser des macromolécules biologiques (ADN et protéines).
                                    <br />L’objectif du CIME Nanotech est maintenant de développer des enseignements ciblés, orientés vers les techniques appliquées propres aux biotechnologies, complémentaires des activités proposées par les autres plateformes d’enseignement de Grenoble Universités, notamment le CUBE. Les travaux pratiques proposés s’appuieront sur l’expérience des équipes grenobloises en biotechnologie.</p>
                                </div><!-- /page-content -->    
                            </div><!-- /page-grid -->
                        </main>
                    </div><!-- /site-content -->
                    ...
                    <div id="sidebar" class="sidebar">
                        <div id="widget-area">
                            <aside class="widget widget_linklist">
                                <ul>
                                    <li class="active"><a href="biotechnologies.php" class="btn btn-gray fullwidth text-left">Présentation</a></li>
                                    <li><a href="bioE.php" class="btn btn-gray fullwidth text-left">Enseignement</a></li>
                                    <li><a href="bioR.php" class="btn btn-gray fullwidth text-left">Réservations</a></li>
                                    <li><a href="bioP.php" class="btn btn-gray fullwidth text-left">Plannings</a></li>
                                    <li><a href="bioEq.php" class="btn btn-gray fullwidth text-left">Equipements</a></li>   
                                </ul>
