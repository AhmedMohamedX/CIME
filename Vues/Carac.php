...
<head>
    ...
    <title>CIME | Caractérisation électrique</title>
</head>
    ...
    <section id="sub-header" class="section bg-parallax pt-0 pb-0" data-background="img/bg/demo.jpg">
        ...
        <div class="container">
            <div class="sub-wrapper">
                <h1>Caractérisation électrique</h1>
                ...
                <div class="breadcrumb-container clearfix">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li>Caractérisation électrique</li>
                        <li><a href="Carac.php">Présentation</a></li>
                    </ul>
                </div><!-- /breadcrumb -->
            </div><!-- /sub-wrapper -->
        </div><!-- /container -->
            ...
            <div class="row">
                <div class="col-md-9 col-md-push-3 col-sm-12 col-xs-12">
                    <div id="content" class="site-content">
                        <main id="main">
                            <h2 class="section-header">Caractérisation électrique</h2>
                            <div class="work-slider mb-20">
                                <img src="img/work/carac1.jpg" alt="" />
                                <img src="img/work/carac2.jpg" alt="" />
                                <img src="img/work/carac3.jpg" alt="" />
                                <img src="img/work/carac4.jpg" alt="" />
                                <img src="img/work/carac5.jpg" alt="" />
                            </div><!-- /work-slider -->

                            <div class="work-item-slider-wrapper">
                                <div class="work-item-slider">
                                    <a href="#"><img src="img/work/thumb/carac1.jpg" alt="" /></a>
                                    <a href="#"><img src="img/work/thumb/carac2.jpg" alt="" /></a>
                                    <a href="#"><img src="img/work/thumb/carac3.jpg" alt="" /></a>
                                    <a href="#"><img src="img/work/thumb/carac4.jpg" alt="" /></a>
                                    <a href="#"><img src="img/work/thumb/carac5.jpg" alt="" /></a>
                                </div><!-- /work-slider -->
                            ...
                            <div class="page-grid">
                                ...
                                <div class="page-content col-8">
                                    ...
                                    <p>Cette plateforme regroupe tous les équipements nécessaires à la caractérisation électrique de composants intégrés.<br>
                                    La caractérisation électrique des composants électroniques (dans le régime des basses fréquences) fait partie des techniques couramment utilisés dans l’industrie pour :<br>
                                    -Faire un retour sur la qualité d’un composant et d’une technologie donnée : performances, défauts électriquement actifs et fiabilité.<br>
                                    -Caractériser une technologie donnée afin de calibrer les modèles compacts utilisés pour la conception électronique.</p>
                                    <br />
                                    <p>Ces techniques nécessitent non seulement des notions de base sur la mesure en courant continu, transitoire ou alternatif, mais également de solides connaissances en physique des semiconducteurs et des composants. En effet, la plupart des mesures donnent ensuite lieu à des extractions plus ou moins poussées basées sur des modèles physiques.<br>
                                    Enfin, il s’agit d’un domaine en plein essor : avec les progrès des technologies, les mesures et leur interprétation s’avèrent de plus en plus complexes (comme par exemple à cause des courants de grille, qui rendent la caractérisation C-V des capacités MOS difficile). D’autre part, l’introduction de nouveaux composants (composants SOI par exemple) ou de nouveaux matériaux (diélectriques alternatifs, canaux contraints etc) augmentent la demande en expertise en caractérisation électrique.</p>
                                </div><!-- /page-content -->    
                            </div><!-- /page-grid -->
                        </main>
                    </div><!-- /site-content -->
                    ...
                    <div id="sidebar" class="sidebar">
                        <div id="widget-area">
                            <aside class="widget widget_linklist">
                                <ul>
                                    <li class="active"><a href="Carac.php" class="btn btn-gray fullwidth text-left">Présentation</a></li>
                                    <li><a href="caracE.php" class="btn btn-gray fullwidth text-left">Enseignement</a></li>
                                    <li><a href="caracR.php" class="btn btn-gray fullwidth text-left">Réservations</a></li>
                                    <li><a href="caracP.php" class="btn btn-gray fullwidth text-left">Plannings</a></li>
                                    <li><a href="caracEq.php" class="btn btn-gray fullwidth text-left">Equipements</a></li>   
                                </ul>
