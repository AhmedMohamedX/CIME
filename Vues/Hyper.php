...
<head>
    ...
    <title>CIME | Hyperfréquence & optique guidée</title>
</head>
    ...
    <section id="sub-header" class="section bg-parallax pt-0 pb-0" data-background="img/bg/demo.jpg">
        ...
        <div class="container">
            <div class="sub-wrapper">
                <h1>Hyperfréquence & optique guidée</h1>
                ...
                <div class="breadcrumb-container clearfix">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li>Hyperfréquence & optique guidée</li>
                        <li><a href="Hyper.php">Présentation</a></li>
                    </ul>
                </div><!-- /breadcrumb -->
            </div><!-- /sub-wrapper -->
        </div><!-- /container -->
            ...
            <div class="row">
                <div class="col-md-9 col-md-push-3 col-sm-12 col-xs-12">
                    <div id="content" class="site-content">
                        <main id="main">
                            <h2 class="section-header">Hyperfréquence & optique guidée</h2>
                            <div class="work-slider mb-20">
                                <img src="img/work/hyp1.jpg" alt="" />
                                <img src="img/work/hyp2.jpg" alt="" />
                                <img src="img/work/hyp3.jpg" alt="" />
                                <img src="img/work/hyp4.jpg" alt="" />
                                <img src="img/work/hyp5.jpg" alt="" />
                            </div><!-- /work-slider -->

                            <div class="work-item-slider-wrapper">
                                <div class="work-item-slider">
                                    <a href="#"><img src="img/work/thumb/hyp1.jpg" alt="" /></a>
                                    <a href="#"><img src="img/work/thumb/hyp2.jpg" alt="" /></a>
                                    <a href="#"><img src="img/work/thumb/hyp3.jpg" alt="" /></a>
                                    <a href="#"><img src="img/work/thumb/hyp4.jpg" alt="" /></a>
                                    <a href="#"><img src="img/work/thumb/hyp5.jpg" alt="" /></a>
                                </div><!-- /work-slider -->
                            ...
                            <div class="page-grid">
                                ...
                                <div class="page-content col-8">
                                    ...
                                    <p>La plateforme a été créée en 1984 sous l’impulsion, notamment, de Michel Bouthinon, alors enseignant à l’Ecole Nationale Supérieure d'Electronique et de Radioélectricité de Grenoble (ENSERG). Il s’agissait alors d’un laboratoire (le LHOG pour Laboratoire d’Hyperfréquences et d’Optique Guidée), en dépendance directe avec l’ENSERG. Un ensemble de travaux pratiques spécifiques aux circuits et systèmes en radiofréquences et en optique guidée était proposé à diverses formations propres à Grenoble INP. Le nombre de bancs de manipulation a peu à peu augmenté. De 7 postes en 1985, il en compte aujourd'hui 17, modulables, ainsi qu'une dizaine de postes de CAO. Des logiciels de simulation et de conception sont disponibles dans les diverses thématiques depuis 1992 et font l’objet d’une mise à jour annuelle. Les outils se sont diversifiés : optique intégrée, optique en espace libre puis les télécommunications depuis les années 2000. Parallèlement, le LHOG s’est ouvert peu à peu aux autres formations dépendant d’autres universités.</p>
                                    <br />
                                    <p>En septembre 2006, dans le cadre de son déménagement sur le site de Minatec, et conjointement avec d’autres salles proposant des outils spécialisées, le laboratoire a rejoint le Centre Interuniversitaire de MicroElectronique (CIME), pour devenir une des différentes plateformes de l’entité CIME Nanotech.<br>
                                    Les points forts de la plateforme HOG sont la modularité des équipements, la mise à disposition de "TP clef en main" ainsi que des conditions de travail très conviviales. Chaque formation s’assure de venir avec son enseignant mais ceux-ci peuvent être formés par les responsables de la plateforme. En retour, les commentaires des différentes formations permettent une amélioration régulière des TPs et des textes proposés ainsi qu’une ouverture sur d’autres façons d’enseigner.</p>
                                </div><!-- /page-content -->    
                            </div><!-- /page-grid -->
                        </main>
                    </div><!-- /site-content -->
                    ...
                    <div id="sidebar" class="sidebar">
                        <div id="widget-area">
                            <aside class="widget widget_linklist">
                                <ul>
                                    <li class="active"><a href="Hyper.php" class="btn btn-gray fullwidth text-left">Présentation</a></li>
                                    <li><a href="hypE.php" class="btn btn-gray fullwidth text-left">Enseignement</a></li>
                                    <li><a href="hypR.php" class="btn btn-gray fullwidth text-left">Réservations</a></li>
                                    <li><a href="hypP.php" class="btn btn-gray fullwidth text-left">Plannings</a></li>
                                    <li><a href="hypEq.php" class="btn btn-gray fullwidth text-left">Equipements</a></li>   
                                </ul>
