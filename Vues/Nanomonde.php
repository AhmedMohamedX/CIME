            ...
            <div class="sub-wrapper">
                ...
                <div class="breadcrumb-container clearfix">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li>Nanomonde</li>
                        <li><a href="Nanomonde.php">Présentation</a></li>
                    </ul>
                </div><!-- /breadcrumb -->
            </div><!-- /sub-wrapper -->
        </div><!-- /container -->
            ...
            <div class="row">
                <div class="col-md-9 col-md-push-3 col-sm-12 col-xs-12">
                    <div id="content" class="site-content">
                        <main id="main">
                            <h2 class="section-header">Nanomonde</h2>
                            <div class="work-slider mb-20">
                                <img src="img/work/nano1.jpg" alt="" />
                                <img src="img/work/nano2.jpg" alt="" />
                                <img src="img/work/nano3.jpg" alt="" />
                                <img src="img/work/nano4.jpg" alt="" />
                                <img src="img/work/nano5.jpg" alt="" />
                            </div><!-- /work-slider -->

                            <div class="work-item-slider-wrapper">
                                <div class="work-item-slider">
                                    <a href="#"><img src="img/work/thumb/nano1.jpg" alt="" /></a>
                                    <a href="#"><img src="img/work/thumb/nano2.jpg" alt="" /></a>
                                    <a href="#"><img src="img/work/thumb/nano3.jpg" alt="" /></a>
                                    <a href="#"><img src="img/work/thumb/nano4.jpg" alt="" /></a>
                                    <a href="#"><img src="img/work/thumb/nano5.jpg" alt="" /></a>
                                </div><!-- /work-slider -->
                            ...
                            <div class="page-grid">
                                ...
                                <div class="page-content col-8">
                                    ...
                                    <p>L’objectif des enseignements pratiques effectués sur cette plateforme est de familiariser les étudiants aux principales techniques de la nano caractérisation en champ proche.</p>
                                    <br />
                                    <p>Inaugurée en 2004, la plateforme nanomonde a pour but principal de permettre un enseignement axé sur les microscopies en champ proche, avec plusieurs approches possibles par le biais de différents appareils : deux AFM (lien1), un STM (lien2) et un profilomètre (lien3). Destinée principalement à l’enseignement, elle reste néanmoins ouverte à la recherche et à l’industrie.
                                    <br />
                                    Localisation: <br>
                                    La plateforme se trouve au premier étage du CIME Nanotech de Minatec Sud, parvis Louis Néel à Grenoble.</p>
                                </div><!-- /page-content -->    
                            </div><!-- /page-grid -->
                        </main>
                    </div><!-- /site-content -->
                    ...
                    <div id="sidebar" class="sidebar">
                        <div id="widget-area">
                            <aside class="widget widget_linklist">
                                <ul>
                                    <li class="active"><a href="Nanomonde.php" class="btn btn-gray fullwidth text-left">Présentation</a></li>
                                    <li><a href="nanoE.php" class="btn btn-gray fullwidth text-left">Enseignement</a></li>
                                    <li><a href="nanoR.php" class="btn btn-gray fullwidth text-left">Réservations</a></li>
                                    <li><a href="nanoP.php" class="btn btn-gray fullwidth text-left">Plannings</a></li>
                                    <li><a href="nanoEq.php" class="btn btn-gray fullwidth text-left">Equipements</a></li>   
                                </ul>
