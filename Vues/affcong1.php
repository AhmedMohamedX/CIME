                        ...
                        <main id="main">
                            ...
                            <img src="img/logo1.png" alt="logo" align="left" /><br> <h5>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;centre interuniversitaire de microelectronique et nanotechnologies</h5><br><HR><br>
                               ...
                               include'../controller/instance.cong.php';
                                $l=$cong->aff_cong1($_GET['m']);
                                    if(!empty ($l)){
                                    extract($l);
                                ?>
                                <h2 class="section-header" align="center">demande de congé </h2>
                               <h2 class="section-header">demande par " <?php echo $demandeur ?> "</h2>

<p>
                                Nom : <?php echo $nom?><br><br>
                                Prénom : <?php echo $prenom?><br><br>
                                Fonction : <?php echo $fonction?><br><br>
                                Responsable : <?php echo $responsable?><br><br>
                                Date de début du congé : <?php echo $dated?><br><br>
                                Date de fin du congé (inclus) : <?php echo $datef?><br><br>
                                <h5 align="right">Fait le . . / . . / . . . . &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h5>
                                <h5 align="right">à . . . . . . . . . . . . . . . . &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h5>
                                <h5 align="right">Signature de responsable</h5><br><br><br><br><br><br><br><br><br><br>
