            ...
            <div class="sub-wrapper">
                ...
                <div class="breadcrumb-container clearfix">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="bioP.php">Plannings</a></li>
                    </ul>
                </div><!-- /breadcrumb -->
            </div><!-- /sub-wrapper -->
        </div><!-- /container -->
                    ...
                    <div id="sidebar" class="sidebar">
                        <div id="widget-area">
                            <aside class="widget widget_linklist">
                                <ul>
                                    <li><a href="biotechnologies.php" class="btn btn-gray fullwidth text-left">Présentation</a></li>
                                    <li><a href="bioE.php" class="btn btn-gray fullwidth text-left">Enseignement</a></li>
                                    <li class="active"><a href="bioR.php" class="btn btn-gray fullwidth text-left">Réservations</a></li>
