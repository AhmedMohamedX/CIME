                    ...
                    <div id="content" class="site-content">
                        <main id="main">
                            ...
                            <div class="page-grid">
                                ...
                                <h2 class="section-header">ajouter une photo</h2>
                                <label>Ordre</label> 
                                <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-bar-chart"></i></span>
                                <input type="number" class="form-control" style="width:40px;" max="3" min="1" placeholder="" autofocus name="ordre1" required>
                                </div>
                                <br>

                                <label>Photo</label> 
                                <div class="input-group">
                                <input type="file" class="form-control" style="width:350px;" placeholder=""   name="nom1" required>
                                </div>
                                <br>
                              ...
                              <br><br>
                               ...
                               <h2 class="section-header">liste des photos</h2>
                                <?php
                                ...
                                ?>
                                    <li>
                                <?php echo $ordre?> <br><br>
                                <img src="img/slider/<?php echo $nom ?>" height="290" width="320" align="left"> <br> <br> <br><br><br><br><br><br>
                                <a href="?cle=<?php echo $id   ?>" onClick="if(!confirm('voulez vous supprimer cette photo?')) return false">supprimer</a> <a href="modifcar.php?m=<?php echo $id  ?>">modifier</a>
                                <br><br>
                                <?php }
                                if(isset($_GET['cle'])){
                                if($caro->supp_car($_GET['cle'])){
                                    $fichier = 'img/slider/'.$nom;
                                    unlink( $fichier ); 
                                ...
                                <?php
                                } else echo 'Pas de photos';
                                if(isset($_POST['ajt'])){
                                    if($caro->exist($_POST['ordre1'])){
                                if($caro->ajt_car($_POST['ordre1'],$_FILES['nom1']['name'])){
                                copy($_FILES['nom1']['tmp_name'],'img/slider/'.$_FILES['nom1']['name']);
                                header("location:car.php");
                                    }
                                    else
                                        echo "<script>alert(\"insert echoueé\")</script>";
                                }else 
                                echo "<script>alert(\"une image existe dans cet ordre !\")</script>";
                            }
                                     ?>
                        ...
                        <div id="widget-area">
                            <aside class="widget widget_linklist">
                                <ul>
                                    ...
                                    <li   class="active"><a href="car.php" class="btn btn-gray fullwidth text-left">Carousel</a></li>  
                                    <?php }?> 
