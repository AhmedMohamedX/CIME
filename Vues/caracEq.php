            ...
            <div class="sub-wrapper">
                ...
                <div class="breadcrumb-container clearfix">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="caracEq.php">Equipements</a></li>
                    </ul>
                </div><!-- /breadcrumb -->
            </div><!-- /sub-wrapper -->
        </div><!-- /container -->
                        ...
                        <main id="main">
                            ...
                            <div class="page-grid">
                                ...
                                <div class="page-content col-8">
                                    <h2 class="section-header">Equipements</h2>
                            ...
                            <ul class="product clearfix mt-30">
                                ...
                                <li>
                                    <div class="product-thumb">
                                        <img src="img/equips/carac/<?php echo $photo ?>" alt="">
                                        <div class="product-icon">
                                        </div><!-- product-icon -->
                                    </div><!-- /product-thumb -->
                                    <h3 class="h5 text-uppercase" align="center"><?php echo $nom ?></h3>
                                    <p class="amount" align="center"><?php echo $version ?></p>
                                </li>
                                <?php }}?>
                            </ul>
                    ...
                    <div id="sidebar" class="sidebar">
                        <div id="widget-area">
                            <aside class="widget widget_linklist">
                                <ul>
                                    <li><a href="Carac.php" class="btn btn-gray fullwidth text-left">Présentation</a></li>
                                    ...
                                    <li  class="active"><a href="caracEq.php" class="btn btn-gray fullwidth text-left">Equipements</a></li>   
                                </ul>
