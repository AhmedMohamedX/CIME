    ...
    <section id="sub-header" class="section bg-parallax pt-0 pb-0" data-background="img/bg/certification.jpg">
        ...
        <div class="container">
            <div class="sub-wrapper">
                <h1>Formations</h1>
                <h2 class="h4">L'éducation est plus qu'un métier, c'est une mission, qui consiste à aider chaque personne à reconnaître ce qu'elle a d'irremplaçable.</h2>
                ...
                <div class="col-md-9 col-md-push-3 col-sm-12 col-xs-12">
                    <div id="content" class="site-content">
                        ...
                        foreach ($forma as $lines ) {
                            ...
                            <h3 class="page-title"><?php echo $nom?></h3>
                            <div class="page-grid">
                                <!-- GRID 9 COLUMNS -->
                        ...
                        <div id="widget-area">
                            <aside class="widget widget_linklist">
                                <ul>
                                    ...
                                    <li class="active"><a href="certification.php" class="btn btn-gray fullwidth text-left">Formations</a></li>
