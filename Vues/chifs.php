                        ...
                        <main id="main">
                            ...
                            <div class="page-grid">
                              ...
                              <form method="post" enctype="multipart/form-data" >
                                <!-- GRID 9 COLUMNS -->
                                <h2 class="section-header">liste des chifres relative au centre</h2>
                                <label>Heures</label>
                                <?php
                                include'../controller/instance.Chiffre.php';
                                $chif=$chiffre->aff_chiffre('heures'); 
                                extract($chif);
                                ?>
                                <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-users"></i></span>
                                <input type="number" min="1" class="form-control" style="width:200px;" placeholder="" autofocus name="heures" value="<?php echo $valeur ?>">
                                </div>
                                <br>
                                <label>Etudiants</label>
                                <?php
                                $chif1=$chiffre->aff_chiffre('Etudiants'); 
                                extract($chif1);
                                ?>
                                <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-users"></i></span>
                                <input type="number" min="1" class="form-control" style="width:200px;" placeholder="" autofocus name="etudiants" value="<?php echo $valeur ?>">
                                </div>
                                <br>
                                <label>Chercheurs</label>
                                <?php
                                $chif2=$chiffre->aff_chiffre('Chercheurs'); 
                                extract($chif2);
                                ?>
                                <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-users"></i></span>
                                <input type="number" min="1" class="form-control" style="width:200px;" placeholder="" autofocus name="chercheurs" value="<?php echo $valeur ?>">
                                </div>
                                <br>
                                <label>Formations</label>
                                <?php
                                $chif=$chiffre->aff_chiffre('Formations'); 
                                extract($chif);
                                ?>
                                <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-users"></i></span>
                                <input type="number" min="1" class="form-control" style="width:200px;" placeholder="" autofocus name="formations" value="<?php echo $valeur ?>">
                                </div>
                                <br>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button type="submit" name="chifs" class="btn btn-primary">Modifier</button>

                              </form>

                               <?php
                               if(isset($_POST['chifs'])){                               
                               if ( (!empty($_POST['heures'])) && (!empty($_POST['etudiants'])) && (!empty($_POST['formations'])) && (!empty($_POST['chercheurs']))  ) {
                               $chiffre->modif_chiffre($_POST['heures'],'heures');  
                               $chiffre->modif_chiffre($_POST['etudiants'],'etudiants');  
                               $chiffre->modif_chiffre($_POST['formations'],'formations');  
                               $chiffre->modif_chiffre($_POST['chercheurs'],'chercheurs');  
                               ?>
                               <br>
                               <div class="alert alert-success alert-dismissible mb-30" style="width:350px;">
                               <i class="fa fa-check"></i><span class="alert-title">succès!</span> succès de modification.
                               </div><!-- /alert -->
                               <?php
                               ...
                               <i class="fa fa-times-circle"></i><span class="alert-title">Erreur!</span> Taper le nombre d'heures
                               </div><!-- /alert -->
                               <?php
                               }      
                               ...
                               <br>
                               <div class="alert alert-error alert-dismissible mb-30" style="width:350px;">
                               <i class="fa fa-times-circle"></i><span class="alert-title">Erreur!</span> Taper le nombre d'étudiants
                               </div><!-- /alert -->
                               <?php
                               }  
                               ...
                               <br>
                               <div class="alert alert-error alert-dismissible mb-30" style="width:350px;">
                               <i class="fa fa-times-circle"></i><span class="alert-title">Erreur!</span> Taper le nombre de formations
                               </div><!-- /alert -->
                               <?php
                               }  
                               if(empty($_POST['chercheurs'])){?>
                               <br>
                               <div class="alert alert-error alert-dismissible mb-30" style="width:350px;">
                               <i class="fa fa-times-circle"></i><span class="alert-title">Erreur!</span> Taper le nombre de chercheurs
                               </div><!-- /alert -->
                               <?php
                               }                                                                                                                      
                               }
                        ...
                        <div id="widget-area">
                            <aside class="widget widget_linklist">
                                <ul>
                                    ...
                                    <li  class="active"><a href="chifs.php" class="btn btn-gray fullwidth text-left">Chifres</a></li>   
