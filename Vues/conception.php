...
<head>
    ...
    <title>CIME | Conception & Test</title>
</head>
            ...
            <div class="sub-wrapper">
                ...
                <div class="breadcrumb-container clearfix">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li>Conception & test</li>
                        <li><a href="conception.php">Présentation</a></li>
                    </ul>
                </div><!-- /breadcrumb -->
            </div><!-- /sub-wrapper -->
        </div><!-- /container -->
            ...
            <div class="row">
                <div class="col-md-9 col-md-push-3 col-sm-12 col-xs-12">
                    <div id="content" class="site-content">
                        <main id="main">
                            <h2 class="section-header">Conception & test</h2>
                            ...
                            <div class="work-item-slider-wrapper">
                                <div class="work-item-slider">
                                    <a href="#"><img src="img/work/thumb/1.jpg" alt="" /></a>
                                    <a href="#"><img src="img/work/thumb/2.jpg" alt="" /></a>
                                    <a href="#"><img src="img/work/thumb/3.jpg" alt="" /></a>
                                    <a href="#"><img src="img/work/thumb/4.jpg" alt="" /></a>
                                    <a href="#"><img src="img/work/thumb/5.jpg" alt="" /></a>
                                </div><!-- /work-slider -->
                            ...
                            <div class="page-grid">
                                ...
                                <div class="page-content col-8">
                                    ...
                                    <p>La plateforme conception et test est distribuée sur un ensemble de locaux dédiés aux activités d’enseignement et de recherche de conception en micro-nano électronique. Vous retrouverez sur cette plateforme tous les outils de conception disponibles au CIME Nanotech ainsi que ceux qui étaient disponibles au LHOG comme ADS ou Optiwave. Une activité à distance est prévue via les réseaux informatiques du site.</p>
                                    <br />
                                    <p>La plateforme conception et test existe depuis la création du CIME en 1981. Elle a été créée pour supporter les activités des universités dans le domaine de la conception microélectronique à la fois pour ces missions d’enseignement que de recherche. A ce jour, la plateforme offre un large éventail de logiciels de CAO microélectronique et microsystèmes. En effet, les concepteurs disposent d’un environnement complet, intégrant les principales suites de logiciels de conception, qui leur permet de concevoir aussi bien des systèmes analogiques, numériques ou mixtes que des microsystèmes. Ce dispositif logiciel est complété par une salle dédiée au prototypage des circuits intégrés et une salle équipée d’un testeur industriel permettant de valider le fonctionnement des puces lors de leur retour de fabrication.</p>
                                </div><!-- /page-content -->    
                            </div><!-- /page-grid -->
                        </main>
                    </div><!-- /site-content -->
                    ...
                    <div id="sidebar" class="sidebar">
                        <div id="widget-area">
                            <aside class="widget widget_linklist">
                                <ul>
                                    <li class="active"><a href="conception.php" class="btn btn-gray fullwidth text-left">Présentation</a></li>
                                    <li><a href="conceptionE.php" class="btn btn-gray fullwidth text-left">Enseignement</a></li>
                                    <li><a href="conceptionR.php" class="btn btn-gray fullwidth text-left">Réservations</a></li>
                                    <li><a href="conceptionP.php" class="btn btn-gray fullwidth text-left">Plannings</a></li>
                                    <li><a href="conceptionEq.php" class="btn btn-gray fullwidth text-left">Equipements</a></li>   
                                </ul>
