            ...
            <div class="sub-wrapper">
                ...
                <div class="breadcrumb-container clearfix">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="conceptionE.php">Enseignement</a></li>
                    </ul>
                </div><!-- /breadcrumb -->
            </div><!-- /sub-wrapper -->
        </div><!-- /container -->
                        ...
                        <main id="main">
                            ...
                            <div class="page-grid">
                                ...
                                <div class="page-content col-8">
                                    <h2 class="section-header">Travaux pratiques & Documents</h2>
    
                                   <?php
                                     include'../controller/instance.doc.php';
                                     $docs=$doc->aff_docs('conception');
                                     if(!empty ($docs)){
                                     foreach ($docs as $lines ) {
                                     extract($lines);
                                     ?>
                                      <h3 class="widget-title"><?php echo $nom ?></h3>
                                      
                                          <a href="documents/conception/<?php echo $fichier ?>" class="btn btn-download fullwidth text-left"><i class="icon icon-pdf19"></i>telechargement.pdf</a>
                    ...
                    <div id="sidebar" class="sidebar">
                        <div id="widget-area">
                            <aside class="widget widget_linklist">
                                <ul>
                                    <li><a href="conception.php" class="btn btn-gray fullwidth text-left">Présentation</a></li>
                                    <li class="active"><a href="conceptionE.php" class="btn btn-gray fullwidth text-left">Enseignement</a></li>
