                   ...
                   <li><a href="index.php">Accueil</a></li>
                    ...
                    <li class="menu-item-has-children">
                        ...
                        <ul class="sub-menu">
                            ...
                            <li><a href="Caract.php">Caractérisation électrique</a></li>
            ...
            <div class="sub-wrapper">
                ...
                <div class="breadcrumb-container clearfix">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="conceptionEq.php">Equipements</a></li>
                    </ul>
                </div><!-- /breadcrumb -->
            </div><!-- /sub-wrapper -->
        </div><!-- /container -->
                            ...
                            <ul class="product clearfix mt-30">
                                ...
                                <li>
                                    <div class="product-thumb">
                                        <img src="img/equips/conception/<?php echo $photo ?>" alt="">
                        ...
                        <div id="widget-area">
                            <aside class="widget widget_linklist">
                                <ul>
                                    ...
                                    <li  class="active"><a href="conceptionEq.php" class="btn btn-gray fullwidth text-left">Equipements</a></li>   
                                </ul>
