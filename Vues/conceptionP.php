            ...
            <div class="sub-wrapper">
                ...
                <div class="breadcrumb-container clearfix">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="conceptionP.php">Plannings</a></li>
                    </ul>
                </div><!-- /breadcrumb -->
            </div><!-- /sub-wrapper -->
        </div><!-- /container -->
                        ...
                        <main id="main">
                            ...
                            <div class="page-grid">
                                ...
                                <div class="page-content col-8">
                                    <h2 class="section-header">Plannings</h2>
    

                                   <?php
                                     include'../controller/instance.plan.php';
                                     $plans=$plan->aff_plans('conception');
                                     if(!empty ($plans)){
                                     ...
                                     ?>
                                      <h3 class="widget-title"><?php echo $nom ?></h3>
                                          ...
                                          <a href="plannings/conception/<?php echo $fichier ?>" class="btn btn-download fullwidth text-left"><i class="icon icon-pdf19"></i>telechargement.pdf</a>
                        ...
                        <div id="widget-area">
                            <aside class="widget widget_linklist">
                                <ul>
                                    ...
                                    <li class="active"><a href="conceptionP.php" class="btn btn-gray fullwidth text-left">Plannings</a></li>
