            ...
            <div class="sub-wrapper">
                ...
                <div class="breadcrumb-container clearfix">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="caracP.php">Plannings</a></li>
                    </ul>
                </div><!-- /breadcrumb -->
            </div><!-- /sub-wrapper -->
        </div><!-- /container -->
                        ...
                        <main id="main">
                            ...
                            <div class="page-grid">
                                ...
                                <div class="page-content col-8">
                                    <h2 class="section-header">vous devez se connecter pour faire une reservation</h2>


                            <h3 class="widget-title h4">Connexion</h3><br>
                            <form  method="post">
                                <input type="text" name="login" value="" style="width:300px;" placeholder="Utilisateur" ><br><br><br>
                                <input type="password" name="motdepasse" style="width:300px;" value="" placeholder="Mot de passe" ><br><br><br>
                        ...
                        <div id="widget-area">
                            <aside class="widget widget_linklist">
                                <ul>
                                    ...
                                    <li class="active"><a href="conceptionR.php" class="btn btn-gray fullwidth text-left">Réservations</a></li>
