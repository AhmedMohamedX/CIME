                        ...
                        <main id="main">
                            ...
                            <div class="page-grid">
                              ...
                              <form method="post" enctype="multipart/form-data" >
                               ...
                               if(isset($_POST['cong'])){
                               $cong->ajt_cong($_POST['nom'],$_POST['prenom'],$_POST['fonction'],'lui même',$_POST['dated'],$_POST['datef'],'3',$_SESSION['login'],date('Y-m-d'));  
                        ...
                        <div id="widget-area">
                            <aside class="widget widget_linklist">
                                <ul>
                                    ...
                                    <li> &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;<font color="#1959A6"><a href="cong.php" >Demander</a></font></li>
