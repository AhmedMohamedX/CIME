                        ...
                        <main id="main">
                            ...
                            <div class="page-grid">
                              ...
                              <form method="post" enctype="multipart/form-data" >
                               ...
                               if(isset($_POST['cong'])){
                               $cong->ajt_cong($_POST['nom'],$_POST['prenom'],$_POST['fonction'],'secrétaire général',$_POST['dated'],$_POST['datef'],'2',$_SESSION['login'],date('Y-m-d'));  
                               header("location:cong1.php");
                                }
                                ?>
                        ...
                        <div id="widget-area">
                            <aside class="widget widget_linklist">
                                <ul>
                                    ...
                                    <li> &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;<font color="#1959A6"><a href="cong1.php" >Demander</a></font></li>
