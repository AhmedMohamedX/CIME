    ...
    <section id="sub-header" class="section bg-parallax pb-0" data-background="img/bg/contact.jpg">
        ...
        <div class="container">
            <div class="sub-wrapper">
                ...
                <h2 class="h4">Une bonne éducation est la source et la racine d'une vie vertueuse.</h2>
            ...
            <div class="row">
                <div class="col-md-8 col-sm-12 col-xs-12">
                    <div id="content" class="site-content">
                        <main id="main">
                            <p>Pour tous renseignements complémentaires sur cette page, nous sommes évidemment à votre entière disposition. </p>

                            <br />

                            <form id="contact-form" action="contact1.php" method="post">
                    ...
                    <div id="sidebar" class="sidebar">
                        <div id="widget-area">
                            <aside class="widget widget_text">
                                <iframe src="https://www.google.com/maps/embed/v1/place?q=3+Parvis+Louis+Néel,+Grenoble,+France&key=AIzaSyAN0om9mFmy1QN6Wf54tXAowK4eT0ZUPrU" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
                            </aside><!-- /widget_text -->
                ...
                $('#contact-form').validate({
                    ...
                    messages: {
                        name: {
                            ...
                            minlength: $.format("Au moins {0} caractères requis.")
                        },
                        subject: {
                            required: "S'il vous plaît entrer votre sujet.",
                            minlength: $.format("Au moins {0} caractères requis.")
                        },
                        email: {
                            required: "S'il vous plaît entrer votre e-mail.",
                    ...
                    submitHandler: function(form) {
                        $('#contact-form button, #contact-form input[type="submit"]').html("Envoi...");
                        $(form).ajaxSubmit({
                            success: function(responseText, statusText, xhr, $form) {
                                ...
                                $('#contact-form button, #contact-form input[type="submit"]').html("Message envoyé");
                            }
                        });
                        return false;
                    }
