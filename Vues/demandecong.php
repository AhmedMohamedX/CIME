                        ...
                        <main id="main">
                            ...
                            <div class="page-grid">
                               ...
                               <?php
                                ...
                                ?>
                                    <li>
                                <h3 style="color:#1ae612;">ID de demande : <?php echo $id?> | Date de demande : <?php echo $date?> | <a href="affcong3.php?m=<?php echo $id  ?>" target="blank">afficher la demande</a></h3>
                                <br><br>
                                <?php 
                        ...
                        <div id="widget-area">
                            <aside class="widget widget_linklist">
                                <ul>
                                    ...
                                    <li> &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;<a href="listecong.php" >Liste des demandes</a></li>
                                    <li> &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;<font color="#1959A6"><a href="demandecong.php" >Mes demandes</a></font></li>
