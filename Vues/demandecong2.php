                    ...
                    <div id="content" class="site-content">
                        <main id="main">
                            ...
                            <div class="page-grid">
                               ...
                               <img src="img/etat1.jpg" height="50" width="700" align="left" /><br><br><br>
                               <?php
                                $l=$cong->aff_cong($_SESSION['login'],'1');
                                if(!empty ($l)){
                                foreach ($l as $lines ) {
                                    extract($lines);
                                ?>
                                    <li>
                                <h3 style="color:#ffa800;">ID de demande : <?php echo $id?> | Date de demande : <?php echo $date?> | <a href="affcong.php?m=<?php echo $id  ?>" target="blank">afficher la demande</a></h3>
                                <br><br>
                                <?php 
                                ...
                                ?>
                                    <li>
                                 <h3 style="color:#966505;">ID de demande : <?php echo $id?> | Date de demande : <?php echo $date?> | <a href="affcong.php?m=<?php echo $id  ?>" target="blank">afficher la demande</a></h3>
                                <br><br>
                                <?php 
                                ...
                                ?>
                                    <li>
                                <h3 style="color:#1ae612;">ID de demande : <?php echo $id?> | Date de demande : <?php echo $date?> | <a href="affcong.php?m=<?php echo $id  ?>" target="blank">afficher la demande</a></h3>
                                <br><br>
                                <?php 
                                ...
                                ?>
                                    <li>
                                <h3 style="color:#fe0000;">ID de demande : <?php echo $id?> | Date de demande : <?php echo $date?> | <a href="affcong.php?m=<?php echo $id  ?>" target="blank">afficher la demande</a></h3>
                                <br><br>
                                <?php 

                                } }

                                if(empty($l) && empty($l1) && empty($l2) && empty($l3)){
                        ...
                        <div id="widget-area">
                            <aside class="widget widget_linklist">
                                <ul>
                                    ...
                                    <li> &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;<a href="cong2.php" >Demander</a></li>
                                    <li> &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;<font color="#1959A6"><a href="demandecong2.php" >Mes demandes</a></font></li>
