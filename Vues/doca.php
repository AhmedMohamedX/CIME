                        ...
                        <main id="main">
                            ...
                            <div class="page-grid">
                              ...
                              <br><br>
                                ...
                                ?><li><?php
                                echo $nom; ?> <br>
                                <a href="?cle=<?php echo $id   ?>" onClick="if(!confirm('voulez vous supprimer ce document?')) return false">supprimer</a> <a href="modifdoc.php?m=<?php echo $id  ?>">modifier</a>
                                </li><?php
                                if(isset($_GET['cle'])){
                                ...
                                ?><li><?php
                                echo $nom; ?> <br>
                                <a href="?cle1=<?php echo $id   ?>" onClick="if(!confirm('voulez vous supprimer ce document?')) return false">supprimer</a> <a href="modifdoc.php?m=<?php echo $id  ?>">modifier</a>
                                </li><?php
                                if(isset($_GET['cle1'])){
                                ...
                                ?><li><?php
                                echo $nom; ?> <br>
                                <a href="?cle2=<?php echo $id   ?>" onClick="if(!confirm('voulez vous supprimer ce document?')) return false">supprimer</a> <a href="modifdoc.php?m=<?php echo $id  ?>">modifier</a>
                                </li><?php
                                if(isset($_GET['cle2'])){
                                ...
                                ?><li><?php
                                echo $nom; ?> <br>
                                <a href="?cle3=<?php echo $id   ?>" onClick="if(!confirm('voulez vous supprimer ce document?')) return false">supprimer</a> <a href="modifdoc.php?m=<?php echo $id  ?>">modifier</a>
                                </li><?php
                                if(isset($_GET['cle3'])){
                                ...
                                ?><li><?php
                                echo $nom; ?> <br>
                                <a href="?cle4=<?php echo $id   ?>" onClick="if(!confirm('voulez vous supprimer ce document?')) return false">supprimer</a> <a href="modifdoc.php?m=<?php echo $id  ?>">modifier</a>
                                </li><?php
                                if(isset($_GET['cle4'])){
                                ...
                                ?><li><?php
                                echo $nom; ?> <br>
                                <a href="?cle5=<?php echo $id   ?>" onClick="if(!confirm('voulez vous supprimer ce document?')) return false">supprimer</a> <a href="modifdoc.php?m=<?php echo $id  ?>">modifier</a>
                                </li><?php
                                if(isset($_GET['cle5'])){
                                ...
                                ?><li><?php
                                echo $nom; ?> <br>
                                <a href="?cle6=<?php echo $id   ?>" onClick="if(!confirm('voulez vous supprimer ce document?')) return false">supprimer</a> <a href="modifdoc.php?m=<?php echo $id  ?>">modifier</a>
                                </li><?php
                                if(isset($_GET['cle6'])){
                                ...
                                ?><li><?php
                                echo $nom; ?> <br>
                                <a href="?cle7=<?php echo $id   ?>" onClick="if(!confirm('voulez vous supprimer ce document?')) return false">supprimer</a> <a href="modifdoc.php?m=<?php echo $id  ?>">modifier</a>
                                </li><?php
                                if(isset($_GET['cle7'])){
