                    ...
                    <div id="content" class="site-content">
                        <main id="main">
                            ...
                            <?php
                               ...
                               $user1=$user->get_user($_SESSION['login']);
                               extract($user1);
                               ?>
                              ...
                              <br><br>
                                ...
                                if($equip->ajt_equip($_POST['nom1'],$_POST['version1'],$plat2,$_FILES['photo1']['name'])){ 
                                    if ($plat2=='conception') {
                                ...
                                <a href="?cle=<?php echo $id   ?>" onClick="if(!confirm('voulez vous supprimer cet equipement?')) return false">supprimer</a> <a href="modifequip1.php?m=<?php echo $id  ?>">modifier</a>
                                </li><?php
                                if(isset($_GET['cle'])){
                        ...
                        <div id="widget-area">
                            <aside class="widget widget_linklist">
                                <ul>
                                    ...
                                    <li  class="active"><a href="eqps.php" class="btn btn-gray fullwidth text-left">equipements</a></li>
                                    <?php }?>
