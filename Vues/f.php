                    ...
                    <div id="content" class="site-content">
                        <main id="main">
                            ...
                            <div class="page-grid">
                                ...
                                <h2 class="section-header">ajouter une question/réponse</h2>
                                <label>Question</label> 
                                <div class="input-group">
                                <textarea name="question1" rows="40" cols="100" maxlength="100" required></textarea>
                                </div>
                                
                                <label>Réponse</label> 
                                <div class="input-group">
                                <textarea name="réponse1" rows="10" cols="100" minlength="20" required></textarea>
                                </div>
                                <br>
                               ...
                               if(isset($_POST['ajt'])){
                               $faq->ajt_faq($_POST['question1'],$_POST['réponse1']);  
                               header("location:f.php");
                                }
                                ?>
                                <h2 class="section-header">liste des question/réponse</h2>
                                ...
                                <?php
                                echo $question?> <br>
                                Réponse: <?php echo substr($reponse, 0, 240)?>....<br> <a href="?cle=<?php echo $id   ?>" onClick="if(!confirm('voulez vous supprimer cette question?')) return false">supprimer</a> <a href="modiffaq.php?m=<?php echo $id  ?>">modifier</a>
                                <br><br>
                                <?php }
                                if(isset($_GET['cle'])){
                                if($faq->supp_faq($_GET['cle'])){
                                    header("location:f.php");
                                }
                                }
                                ?>
                        ...
                        <div id="widget-area">
                            <aside class="widget widget_linklist">
                                <ul>
                                    ...
                                    <li  class="active"><a href="f.php" class="btn btn-gray fullwidth text-left">FAQ</a></li> 
