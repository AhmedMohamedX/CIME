...
<div id="page-wrap">
    <!-- SUB HEADER -->
    <section id="sub-header" class="section bg-parallax pt-0 pb-0" data-background="img/bg/faq.jpg">
        <div class="bg-overlay-black bg-overlay-5"></div>
        <div class="container">
            <div class="sub-wrapper">
                <h1>F.A.Q</h1>
                <h2 class="h4">Le contenu d'un livre contient le pouvoir de l'éducation, et c'est grâce à ce pouvoir que l'on peut créer un futur et changer des vies.</h2>
                ...
                <div class="col-md-9 col-md-push-3 col-sm-12 col-xs-12">
                    <div id="content" class="site-content">
                        <main id="main">
                            ...
                            <h2 class="section-header">Foire aux questions</h2>
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-xs-12">
                                    ...
                                    <?php
                                     ...
                                     $i=1;
                                     if(!empty ($faqs)){
                                     foreach ($faqs as $lines ) {
                                     extract($lines);
                                     ?>
                                        <div class="panel">
                                            <button class="panel-btn collapsed" type="button" data-parent="#accordion1" data-toggle="collapse" data-target="#content<?php echo $i ?>" aria-expanded="false" aria-controls="content<?php echo $i?>">
                                                <?php echo $question ?>
                                            </button>
                                            <div id="content<?php echo $i ?>" class="collapse" aria-expanded="false">
                            ...
                            <a href="contact.php" class="btn btn-primary radius">Contactez-nous</a>
                        </main>
                    </div><!-- /site-content -->
                </div><!-- /col -->
                        ...
                        <div id="widget-area">
                            <aside class="widget widget_linklist">
                                <ul>
                                    ...
                                    <li class="active"><a href="faqs.php" class="btn btn-gray fullwidth text-left">F.A.Q</a></li>
