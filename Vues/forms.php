                        ...
                        <main id="main">
                            ...
                            <div class="page-grid">
                             ...
                             <form method="post" enctype="multipart/form-data" >
                                ...
                                <input type="text" class="form-control" style="width:340px;" placeholder=""   name="nom1" required>
                                </div><br>
                                ...
                                <label>Texte</label> 
                                <div class="input-group">
                                <textarea name="texte1" rows="40" cols="100" minlength="20" required></textarea>
                                </div><br>
                              ...
                              <br><br>
                               ...
                               <h2 class="section-header">liste des formations</h2>
                                ...
                                Texte: <?php echo substr($texte, 0, 180)?>.....<br>
                                <a href="?cle=<?php echo $id   ?>" onClick="if(!confirm('voulez vous supprimer cette formation?')) return false">supprimer</a> <a href="modifform.php?m=<?php echo $id  ?>">modifier</a>
                                <br><br>
                                <?php } }
                                if(isset($_GET['cle'])){
                                if($formations->supp_form($_GET['cle'])){
                                ...
                                if(isset($_POST['ajt'])){
                                if($formations->ajt_form($_POST['nom1'],$_POST['texte1'],$_FILES['logo1']['name'])){
                        ...
                        <div id="widget-area">
                            <aside class="widget widget_linklist">
                                <ul>
                                    ...
                                    <li  class="active"><a href="forms.php" class="btn btn-gray fullwidth text-left">Formations</a></li>
