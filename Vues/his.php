...
<form method="post" enctype="multipart/form-data" >
                                <h2 class="section-header">ajouter une historique</h2>
                                <label>Titre</label> 
                              ...
                              <br><br>
                               ...
                               <h2 class="section-header">liste des historiques</h2>
                                <?php
                                include'../controller/instance.histo.php';
                                $acts=$histo->get_histo();
                                if(!empty ($acts)){
                                ...
                                <?php echo $date ?><br> <a href="?cle=<?php echo $id   ?>" onClick="if(!confirm('voulez vous supprimer cette historique?')) return false">supprimer</a> <a href="modifhis.php?m=<?php echo $id  ?>">modifier</a>
                                <br><br>
                                <?php }
                                if(isset($_GET['cle'])){
                                if($histo->supp_his($_GET['cle'])){
                                ...
                                <?php
                                } else echo 'Pas de historique';
                                if(isset($_POST['ajt'])){
                                if($histo->ajt_his($_POST['titre1'],$_POST['texte1'],$_POST['date1'],$_FILES['photo1']['name'])){
                                copy($_FILES['photo1']['tmp_name'],'img/history/'.$_FILES['photo1']['name']);
                                header("location:his.php");
                                    }
                                    else
