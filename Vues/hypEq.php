            ...
            <div class="sub-wrapper">
                ...
                <div class="breadcrumb-container clearfix">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="hypEq.php">Equipements</a></li>
                    </ul>
                </div><!-- /breadcrumb -->
            </div><!-- /sub-wrapper -->
        </div><!-- /container -->
                          ...
                          <ul class="product clearfix mt-30">
                                ...
                                <li>
                                    <div class="product-thumb">
                                        <img src="img/equips/hyper/<?php echo $photo ?>" alt="">
                        ...
                        <div id="widget-area">
                            <aside class="widget widget_linklist">
                                <ul>
                                    ...
                                    <li  class="active"><a href="hypEq.php" class="btn btn-gray fullwidth text-left">Equipements</a></li>   
                                </ul>
