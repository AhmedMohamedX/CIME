                        ...
                        <main id="main">
                            ...
                            ?>
                              ...
                              <form method="post" enctype="multipart/form-data" >
                                <!-- GRID 9 COLUMNS -->
                                <h2 class="section-header">Informations du centre</h2>
                                <label>Adresse</label> 
                                <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-users"></i></span>
                                <input type="text" class="form-control" style="width:550px;" placeholder="" autofocus name="adr" required value="<?php echo $adresse ?>">
                                </div>
                                <br>
                                <label>Numéro de téléphone fixe</label> 
                                <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-shield"></i></span>
                                <input type="text" class="form-control" style="width:550px;" placeholder="" autofocus  name="F" required value="<?php echo $telF ?>">
                                </div><br>
                                <label>Numéro de téléphone portable</label> 
                                <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-shield"></i></span>
                                <input type="text" class="form-control" style="width:550px;" placeholder="" autofocus  name="P" required value="<?php echo $telP ?>">
                                </div><br>
                                <label>E-mail</label> 
                                <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-shield"></i></span>
                                <input type="text" class="form-control" style="width:550px;" placeholder="" autofocus  name="M" required value="<?php echo $mail ?>">
                                </div>
                                <br>
                                <label>Horaires</label> 
                                <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-shield"></i></span>
                                <input type="text" class="form-control" style="width:550px;" placeholder="" autofocus  name="H" required value="<?php echo $horaires ?>">
                                </div>
                                <br>
                               ...
                               $info->modif_info($_POST['adr'],$_POST['F'],$_POST['P'],$_POST['M'],$_POST['H']);  
                               header("location:infs.php");
                               }
                                ?>
                        ...
                        <div id="widget-area">
                            <aside class="widget widget_linklist">
                                <ul>
                                    ...
                                    <li  class="active"><a href="infs.php" class="btn btn-gray fullwidth text-left">Informations</a></li>     
