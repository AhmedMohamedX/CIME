                    ...
                    <div id="content" class="site-content">
                        <main id="main">
                            ...
                            <div class="page-grid">
                               ...
                               $type=$_SESSION['type'];
                               ?>
                               <h2 class="section-header">liste des demandes en attente de votre confirmation</h2>
                               <?php
                                $l=$cong->aff_cong3('2');
                                if(!empty ($l)){
                                foreach ($l as $lines ) {
                                ...
                                ?>
                                    <li>
                                Login de saisisseur : <?php echo $demandeur?> <a href="affcong4.php?m=<?php echo $id  ?>" target="blank">afficher la demande</a><br><br>
                                ...
                                <?php 
                                if(isset($_GET['ac'])){
                                if($cong->set_cong($_GET['ac'],'3')){
                                header("location:listecong.php");
                                }
                                }
                                if(isset($_GET['re'])){
                                if($cong->set_cong($_GET['re'],'4')){
                                header("location:listecong.php");
                                }
                                }
                               ...
                               <?php
                                ...
                                ?>
                                    <li>
                                Login de saisisseur : <?php echo $demandeur?> <a href="affcong4.php?m=<?php echo $id  ?>" target="blank">afficher la demande</a><br><br>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="?acc1=<?php echo $id   ?>" onClick="if(!confirm('voulez vous accepter cette demande?')) return false">Accepter</a> 
                                <a href="?sup1=<?php echo $id   ?>" onClick="if(!confirm('voulez vous supprimer cette demande?')) return false">Supprimer</a><br><br>
                                <?php 
                                if(isset($_GET['acc1'])){
                                if($cong->set_cong($_GET['acc1'],'3')){
                                header("location:listecong.php");
                                }
                                }
                                if(isset($_GET['sup1'])){
                                if($cong->supp_cong($_GET['sup1'])){
                                header("location:listecong.php");
                                }
                                }
                                }
                               ...
                               <?php
                                ...
                                ?>
                                    <li>
                                Login de saisisseur : <?php echo $demandeur?> <a href="affcong4.php?m=<?php echo $id  ?>" target="blank"> afficher la demande</a><br>
                        ...
                        <div id="widget-area">
                            <aside class="widget widget_linklist">
                                <ul>
                                    ...
                                    <li   class="active"><a href="cong.php" class="btn btn-gray fullwidth text-left">Congés</a></li>
                                    <li> &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;<a href="cong.php" >Demander</a></li>
                                    <li> &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;<font color="#1959A6"><a href="listecong.php" >Liste des demandes</a></font></li>
                                    <li> &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;<a href="demandecong.php" >Mes demandes</a></li>
