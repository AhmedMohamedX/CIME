                    ...
                    <div id="content" class="site-content">
                        <main id="main">
                            ...
                            <div class="page-grid">
                               ...
                               <?php
                                $l=$cong->aff_cong2('1',$type);
                                if(!empty ($l)){
                                foreach ($l as $lines ) {
                                    extract($lines);
                                ?>
                                    <li>
                                Login de saisisseur : <?php echo $demandeur?> <a href="affcong2.php?m=<?php echo $id  ?>" target="blank">afficher la demande</a><br><br>
                                ...
                                <?php 
                                if(isset($_GET['ac'])){
                                if($cong->set_cong($_GET['ac'],'2')){
                                header("location:listecong1.php");
                                }
                                }
                                if(isset($_GET['re'])){
                                ...
                                ?><br>
                               <h2 class="section-header">liste des demandes en attente de confirmation de secrétaire général</h2>
                               <?php
                                $l1=$cong->aff_cong2('2',$type);
                                if(!empty ($l1)){
                                foreach ($l1 as $lines ) {
                                    extract($lines);
                                ?>
                                    <li>
                                Login de saisisseur : <?php echo $demandeur?> <a href="affcong2.php?m=<?php echo $id  ?>" target="blank"> afficher la demande</a><br>

                                <br><br>
                                <?php } }else{
                                    echo "pas de demandes en attente de confirmation de secrétaire général";
                                }
                                ?><br>
                        ...
                        <div id="widget-area">
                            <aside class="widget widget_linklist">
                                <ul>
                                    ...
                                    <li> &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;<font color="#1959A6"><a href="listecong1.php" >Liste des demandes</a></font></li>
                                    <li> &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;<a href="demandecong1.php" >Mes demandes</a></li>
                                    <?php } ?>
                                    <?php if($_SESSION['type']!='admin'){?>
