                    ...
                    <div id="content" class="site-content">
                        <main id="main">
                            ...
                            <div class="page-grid">
                               ...
                               <?php
                                $l=$res->aff_demande2('1',$plat2);
                                if(!empty ($l)){
                                foreach ($l as $lines ) {
                                    extract($lines);
                                ?>
                                    <li>
                                Login de saisisseur : <?php echo $demandeur?> <a href="affdemande1.php?m=<?php echo $id  ?>" target="blank">afficher la demande</a><br><br>
                               ...
                               <?php
                                $l=$res->aff_demande2('2',$plat2);
                                if(!empty ($l)){
                                foreach ($l as $lines ) {
                                    extract($lines);
                                ?>
                                    <li>
                                Login de saisisseur : <?php echo $demandeur?> <a href="affdemande1.php?m=<?php echo $id  ?>" target="blank"> afficher la demande</a><br>
                        ...
                        <div id="widget-area">
                            <aside class="widget widget_linklist">
                                <ul>
                                    ...
                                    <li> &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;<a href="res1.php" >Reserver</a></li>
                                    <li> &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;<font color="#1959A6"><a href="listeres1.php" >Liste des demandes</a></font></li>
