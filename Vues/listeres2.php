                        ...
                        <main id="main">
                            ...
                            <div class="page-grid">
                               ...
                               <?php
                                ...
                                ?>
                                    <li>
                                <h3 style="color:#ffa800;">ID de demande : <?php echo $id?> | Date de demande : <?php echo $date?> | <a href="affdemande3.php?m=<?php echo $id  ?>" target="blank">afficher la demande</a></h3>
                                <br><br>
                                <?php 
                                ...
                                ?>
                                    <li>
                                 <h3 style="color:#1ae615;">ID de demande : <?php echo $id?> | Date de demande : <?php echo $date?> | <a href="affdemande3.php?m=<?php echo $id  ?>" target="blank">afficher la demande</a></h3>
                                <br><br>
                                <?php 
                                ...
                                ?>
                                    <li>
                                <h3 style="color:#fe0000;">ID de demande : <?php echo $id?> | Date de demande : <?php echo $date?> | <a href="affdemande3.php?m=<?php echo $id  ?>" target="blank">afficher la demande</a></h3>
                                <br><br>
                                <?php 
                        ...
                        <div id="widget-area">
                            <aside class="widget widget_linklist">
                                <ul>
                                    ...
                                    <li> &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;<a href="res2.php" >Reserver</a></li>
                                    <li> &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;<font color="#1959A6"><a href="listeres2.php" >Mes demandes</a></font></li>
