                    ...
                    <div id="content" class="site-content">
                        <main id="main">
                            ...
                            <div class="page-grid">
                               ...
                               <h2 class="section-header">liste de mes demandes</h2>
                               <img src="img/etat.jpg" height="50" width="500" align="left" /><br><br><br>
                               <?php
                                $l=$res->aff_demande3($_SESSION['login'],'1');
                                if(!empty ($l)){
                                foreach ($l as $lines ) {
                                    extract($lines);
                                ?>
                                    <li>
                                <h3 style="color:#ffa800;">ID de demande : <?php echo $id?> | Date de demande : <?php echo $date?> | <a href="affdemande2.php?m=<?php echo $id  ?>" target="blank">afficher la demande</a></h3>
                                <br><br>
                                <?php 

                                } }
                                $l2=$res->aff_demande3($_SESSION['login'],'2');
                                if(!empty ($l2)){
                                foreach ($l2 as $lines2 ) {
                                    extract($lines2);
                                ?>
                                    <li>
                                 <h3 style="color:#1ae615;">ID de demande : <?php echo $id?> | Date de demande : <?php echo $date?> | <a href="affdemande2.php?m=<?php echo $id  ?>" target="blank">afficher la demande</a></h3>
                                <br><br>
                                <?php 

                                } }
                                $l1=$res->aff_demande3($_SESSION['login'],'3');
                                if(!empty ($l1)){
                                foreach ($l1 as $lines1 ) {
                                    extract($lines1);
                                ?>
                                    <li>
                                <h3 style="color:#fe0000;">ID de demande : <?php echo $id?> | Date de demande : <?php echo $date?> | <a href="affdemande2.php?m=<?php echo $id  ?>" target="blank">afficher la demande</a></h3>
                                <br><br>
                                <?php 

                                } }

                                if(empty($l) && empty($l1) && empty($l2)){
                        ...
                        <div id="widget-area">
                            <aside class="widget widget_linklist">
                                <ul>
                                    ...
                                    <li> &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;<a href="res3.php" >Reserver</a></li>
                                    <li> &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;<font color="#1959A6"><a href="listeres3.php" >Mes demandes</a></font></li>
