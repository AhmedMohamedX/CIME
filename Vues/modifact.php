                    ...
                    <div id="content" class="site-content" >
                        <main id="main">
                            ...
                            <div class="page-grid" >
                                ...
                                $us=$actua->get_actua($_GET['m']);
                                extract($us);
                                ?>
                                <form method="post" enctype="multipart/form-data" >
                                <!-- GRID 9 COLUMNS -->
                                <h2 class="section-header">Modifier l'actualité " <?php echo $id ?> "</h2>
                                <label>Titre</label> 
                               ...
                               if(isset($_POST['modif'])){
                                if ( (!empty($_POST['titre0'])) && (!empty($_POST['date0'])) && (!empty($_POST['texte0']))  ) {
                                if(empty($_FILES['photo0']['name'])){
                                $photo2=$photo;
                                }else{
                                $photo2=$_FILES['photo0']['name'];
                                copy($_FILES['photo0']['tmp_name'],'img/actuas/'.$_FILES['photo0']['name']);
                                $fichier = 'img/actuas/'.$photo;
                                unlink( $fichier ) ;
                                }

                               $actua->modif_act($_GET['m'],$_POST['titre0'],$_POST['date0'],$_POST['texte0'],$photo2);  
