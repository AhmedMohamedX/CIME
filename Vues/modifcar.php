                    ...
                    <div id="content" class="site-content" >
                        <main id="main">
                            ...
                            <div class="page-grid" >
                                ...
                                $us=$caro->get_caro1($_GET['m']);
                                extract($us);
                                ?>
                                <form method="post" enctype="multipart/form-data" >
                                <h2 class="section-header">Modifier la photo <?php echo $ordre ?></h2>
                                <label>Ordre</label> 
                                <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-bar-chart"></i></span>
                                <input type="number" class="form-control" style="width:40px;" max="3" min="1" value="<?php echo $ordre ?>" placeholder="" autofocus name="ordre0" required>
                                </div>
                                <br>
                                <img src="img/slider/<?php echo $nom ?>" height="290" width="320" align="left"> <br> <br> <br><br><br><br><br><br>
                                <label>Photo</label> 
                                <div class="input-group">
                                <input type="file" class="form-control" style="width:350px;" placeholder=""   name="nom0">
                                </div>
                                <br>
                               ...
                               if(isset($_POST['modif'])){
                                if($caro->exist($_POST['ordre0']) | $_POST['ordre0']==$ordre ){
                                if(empty($_FILES['nom0']['name'])){
                                $photo2=$nom;
                                }else{
                                $photo2=$_FILES['nom0']['name'];
                                copy($_FILES['nom0']['tmp_name'],'img/slider/'.$_FILES['nom0']['name']);
                                $fichier = 'img/slider/'.$photo;
                                unlink( $fichier ) ;
                                }

                               $caro->modif_car($_GET['m'],$_POST['ordre0'],$photo2);  
