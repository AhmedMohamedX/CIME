                    ...
                    <div id="content" class="site-content" >
                        <main id="main">
                            ...
                            <div class="page-grid" >
                                ...
                                $us=$contact->get_cont($_GET['m']);
                                extract($us);
                                ?>
                                <form method="post" enctype="multipart/form-data" >
                                <!-- GRID 9 COLUMNS -->
                                <h2 class="section-header">Modifier le contact " <?php echo $nom ?> "</h2>
                                <label>Nom</label> 
                                ...
                                <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-bar-chart"></i></span>
                                <input type="text" class="form-control" style="width:350px;" placeholder="" autofocus  name="fonction0" value="<?php echo $fonction ?>" required>
                                </div><br>
                                <label>E-mail</label> 
                                <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-bar-chart"></i></span>
                                <input type="text" class="form-control" style="width:350px;" placeholder="" autofocus  name="mail0" value="<?php echo $mail ?>" required>
                                </div><br>
                                <label>LinkedIN</label> 
                                <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-bar-chart"></i></span>
                                <input type="text" class="form-control" style="width:350px;" placeholder="" autofocus  name="link0" value="<?php echo $linkedin ?>" required>
                                </div><br>
                                <label>Texte</label> 
                                <div class="input-group">
                                <textarea name="texte0" rows="40" cols="100" required minlength="10"><?php echo $texte ?></textarea>
                                </div>
                                <label>Photo</label> 
                                <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-bar-chart"></i></span>
                                <input type="file" class="form-control" style="width:350px;" placeholder="" autofocus  name="photo0">
                                </div>
                                <br>
                               ...
                               if(isset($_POST['modif'])){
                                if ( $_POST['fonction0']=='Directeur & Fondateur - CIME' ){?>
                                <br>
                                ...
                                copy($_FILES['photo0']['tmp_name'],'img/contacts/'.$_FILES['photo0']['name']);
                                $fichier = 'img/contacts/'.$photo;
                                unlink( $fichier ) ;
                                }

                                $contact->modif_cont($_GET['m'],$_POST['nom0'],$_POST['fonction0'],$_POST['mail0'],$_POST['link0'],$_POST['texte0'],$photo2);  
