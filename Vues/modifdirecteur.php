                    ...
                    <div id="content" class="site-content" >
                        <main id="main">
                            ...
                            <div class="page-grid" >
                                ...
                                <!-- GRID 9 COLUMNS -->
                                <h2 class="section-header">Modifier le directeur " <?php echo $nom ?> "</h2>
                                <label>Nom</label> 
                                ...
                                <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-bar-chart"></i></span>
                                <input type="text" class="form-control" style="width:350px;" placeholder="" autofocus  name="fonction0" value="<?php echo $fonction ?>" required readonly="true">
                                </div><br>
                                <label>E-mail</label> 
                                <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-bar-chart"></i></span>
