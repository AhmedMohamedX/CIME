                    ...
                    <div id="content" class="site-content" >
                        <main id="main">
                            ...
                            <form method="post" enctype="multipart/form-data" >
                                ...
                                $us=$faq->get_faq($_GET['m']);
                                extract($us);
                                ?>
                                <h2 class="section-header">Modifier la question/réponse " <?php echo $id ?> "</h2>
                                
                                <!-- GRID 9 COLUMNS -->
                                <label>Question</label> 
                                <div class="input-group">
                                <textarea name="question0" rows="40" cols="100" maxlength="100"  required><?php echo $question ?></textarea>
                                </div>
                                
                                <label>Réponse</label> 
                                <div class="input-group">
                                <textarea name="rep0" rows="10" cols="100" minlength="20" required ><?php echo $reponse ?></textarea>
                                </div>
                                <br>
                               ...
                               if(isset($_POST['modif'])){
                                $ques=$_POST['question0'];
                                $rep=$_POST['rep0'];
                                $faq->modif_faq($_GET['m'],$ques,$rep);
