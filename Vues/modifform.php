                    ...
                    <div id="content" class="site-content" >
                        <main id="main">
                            ...
                            <div class="page-grid" >
                                ...
                                $us=$formations->aff_form($_GET['m']);
                                extract($us);
                                ?>
                                <form method="post" enctype="multipart/form-data" >
                                <h2 class="section-header">Modifier la formation " <?php echo $nom ?> "</h2>
                                <label>Nom</label> 
                                <div class="input-group">
                                <input type="text" class="form-control" style="width:340px;" placeholder=""  value="<?php echo $nom ?>" name="nom0" required>
                                </div><br>
                                ...
                                <label>Texte</label> 
                                <div class="input-group">
                                <textarea name="texte0" rows="40" cols="100" minlength="20" required ><?php echo $texte ?></textarea>
                                </div><br>
                               ...
                               if(isset($_POST['modif'])){
                                ...
                                $formations->modif_form($_GET['m'],$_POST['nom0'],$_POST['texte0'],$photo2);  
