                    ...
                    <div id="content" class="site-content" >
                        <main id="main">
                            ...
                            <div class="page-grid" >
                                ...
                                $us=$histo->get_his($_GET['m']);
                                extract($us);
                                ?>
                                <form method="post" enctype="multipart/form-data" >
                                <!-- GRID 9 COLUMNS -->
                                <h2 class="section-header">Modifier l'historique du " <?php echo $date ?> "</h2>
                                <label>Titre</label> 
                                <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-bar-chart"></i></span>
                                <input type="text" class="form-control" style="width:350px;" placeholder="" autofocus name="titre0" value="<?php echo $titre ?>" required>
                                </div>
                                <br>
                                <label>Date</label> 
                                <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-bar-chart"></i></span>
                                <input type="date" class="form-control" style="width:350px;" placeholder="" autofocus  name="date0" value="<?php echo $date ?>" required>
                                </div><br>
                                <label>Texte</label> 
                                <div class="input-group">
                                <textarea name="texte0" rows="40" cols="100" required minlength="50"><?php echo $texte ?></textarea>
                                </div>
                                <label>Photo</label> 
                                <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-bar-chart"></i></span>
                               ...
                               if(isset($_POST['modif'])){
                                ...
                                copy($_FILES['photo0']['tmp_name'],'img/history/'.$_FILES['photo0']['name']);
                                $fichier = 'img/history/'.$photo;
                                unlink( $fichier ) ;
                                }

                               $histo->modif_his($_GET['m'],$_POST['titre0'],$_POST['date0'],$_POST['texte0'],$photo2);  
                        ...
                        <div id="widget-area">
                            <aside class="widget widget_linklist">
                                <ul>
                                    ...
                                    <li  class="active"><a href="his.php" class="btn btn-gray fullwidth text-left">Historique</a></li>    
