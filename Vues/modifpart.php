                    ...
                    <div id="content" class="site-content" >
                        <main id="main">
                            ...
                            <div class="page-grid" >
                                ...
                                $us=$part->aff_part($_GET['m']);
                                extract($us);
                                ?>
                               <form method="post" enctype="multipart/form-data" >
                                <h2 class="section-header">Modifier le partenaire " <?php echo $id ?> "</h2>
                                <label>Type</label> 
                                <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-users"></i></span>
                                <select name="type0" style="width:300px;">
                                <option value="locaux" <?php if($type=='locaux'){ ?> selected <?php } ?> >local</option>
                                <option value="Euro" <?php if($type=='euro'){ ?> selected <?php } ?> >Européen</option>
                                </select>
                                </div><br>
                                ...
                                <input type="text" class="form-control" style="width:300px;" placeholder="" value="<?php echo $lien ?>" autofocus name="lien0" required>
                                </div>
                                <br>
                                
                                <label>Logo</label> 
                                <div class="input-group">
                                <input type="file" class="form-control" style="width:340px;" placeholder=""   name="logo0" >
                                </div><br>
                               ...
                               if(isset($_POST['modif'])){
                                if(empty($_FILES['logo0']['name'])){
                                $photo2=$logo;
                                }else{
                                $photo2=$_FILES['logo0']['name'];
                                copy($_FILES['logo0']['tmp_name'],'img/client/'.$_FILES['logo0']['name']);
                                $fichier = 'img/client/'.$logo;
                                unlink( $fichier ) ;
                                }

                                $part->modif_part($_GET['m'],$_POST['type0'],$_POST['lien0'],$photo2);  
