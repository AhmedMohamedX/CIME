                    ...
                    <div id="content" class="site-content" >
                        <main id="main">
                            ...
                            <div class="page-grid" >
                                ...
                                $us=$tarif->get_tarif($_GET['m']);
                                extract($us);
                                ?>
                                <form method="post" enctype="multipart/form-data" >
                                <!-- GRID 9 COLUMNS -->
                                <h2 class="section-header">Modifier la tarif " <?php echo $nom ?> " pour <?php echo $type ?></h2>
                                <label>Nom</label> 
                                <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-bar-chart"></i></span>
                                <input type="text" class="form-control" style="width:350px;" placeholder="" autofocus name="nom0" value="<?php echo $nom ?>" required>
                                </div>
                                <br>
                                <label>Nombre des heures</label> 
                                <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-bar-chart"></i></span>
                                <input type="text" class="form-control" style="width:350px;" placeholder="" autofocus  name="h" value="<?php echo $nbrheures ?>" required>
                                </div><br>
                                <label>Nombre des projets</label> 
                                <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-bar-chart"></i></span>
                                <input type="text" class="form-control" style="width:350px;" placeholder="" autofocus  name="p" value="<?php echo $nbrprojets ?>" required>
                                </div><br>
                                <label>Nombre des enseignants</label> 
                                <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-bar-chart"></i></span>
                                <input type="text" class="form-control" style="width:350px;" placeholder="" autofocus  name="e" value="<?php echo $nbrenseignants ?>" required>
                                </div><br>
                                <label>Nombre des salles</label> 
                                <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-bar-chart"></i></span>
                                <input type="text" class="form-control" style="width:350px;" placeholder="" autofocus  name="s" value="<?php echo $nbrsalles ?>" required>
                                </div><br>
                                <label>Tarif</label> 
                                <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-bar-chart"></i></span>
                                <input type="text" class="form-control" style="width:350px;" placeholder="" autofocus  name="t" value="<?php echo $tarif ?>" required>
                                </div><br>
                               ...
                               if(isset($_POST['modif'])){
                                $tarif1= new tarifs();
                                $tarif1->modif_tarf($_GET['m'],$_POST['nom0'],$_POST['h'],$_POST['p'],$_POST['e'],$_POST['s'],$_POST['t']);  
                                header("location:tarfs.php");
                                }
                        ...
                        <div id="widget-area">
                            <aside class="widget widget_linklist">
                                <ul>
                                    ...
                                    <li class="active"><a href="tarfs.php" class="btn btn-gray fullwidth text-left">tarifs</a></li>
