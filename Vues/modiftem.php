                    ...
                    <div id="content" class="site-content" >
                        <main id="main">
                            ...
                            <div class="page-grid" >
                                ...
                                $us=$tem->get_tem($_GET['m']);
                                extract($us);
                                ?>
                                <form method="post" enctype="multipart/form-data" >
                                <!-- GRID 9 COLUMNS -->
                                <h2 class="section-header">Modifier le témoignage de " <?php echo $nom ?> "</h2>
                                <label>Nom</label> 
                               ...
                               if(isset($_POST['modif'])){
                                ...
                                $tem->modif_tem($_GET['m'],$_POST['nom0'],$_POST['fonction0'],$_POST['texte0'],$photo2);  
                        ...
                        <div id="widget-area">
                            <aside class="widget widget_linklist">
                                <ul>
                                    ...
                                    <li class="active"><a href="tems.php" class="btn btn-gray fullwidth text-left">Témoignages</a></li>
