                    ...
                    <div id="content" class="site-content" >
                        <main id="main">
                            ...
                            <div class="page-grid" >
                                ...
                                $us=$valeur->get_val($_GET['m']);
                                extract($us);
                                ?>
                                <form method="post" enctype="multipart/form-data" >
                                <!-- GRID 9 COLUMNS -->
                                <h2 class="section-header">Modifier la valeur <?php echo $type ?></h2>
                                <label>Type</label> 
                                <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-bar-chart"></i></span>
                                <input type="text" class="form-control" style="width:350px;" placeholder="" autofocus name="type0" value="<?php echo $type ?>" required>
                                </div>
                                <br>

                                <label>Texte</label> 
                                <div class="input-group">
                                <textarea name="texte0" rows="40" cols="100" required minlength="20"><?php echo $texte ?></textarea>
                                </div>
                                <br>
                               ...
                               $valeur->modif_val($_GET['m'],$_POST['type0'],$_POST['texte0']);  
                        ...
                        <div id="widget-area">
                            <aside class="widget widget_linklist">
                                <ul>
                                    ...
                                    <li  class="active"><a href="vals.php" class="btn btn-gray fullwidth text-left">Valeurs</a></li>  
