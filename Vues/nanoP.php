                                   ...
                                   <?php
                                     ...
                                     ?>
                                      <h3 class="widget-title"><?php echo $nom ?></h3>
                                          ...
                                          <a href="plannings/nanomonde/<?php echo $fichier ?>" class="btn btn-download fullwidth text-left"><i class="icon icon-pdf19"></i>telechargement.pdf</a>
                        ...
                        <div id="widget-area">
                            <aside class="widget widget_linklist">
                                <ul>
                                    ...
                                    <li class="active"><a href="nanoP.php" class="btn btn-gray fullwidth text-left">Plannings</a></li>
