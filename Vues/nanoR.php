            ...
            <div class="sub-wrapper">
                ...
                <div class="breadcrumb-container clearfix">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li>Nanomonde</li>
                        <li><a href="nanoP.php">Plannings</a></li>
                    </ul>
                </div><!-- /breadcrumb -->
            </div><!-- /sub-wrapper -->
        </div><!-- /container -->
                    ...
                    <div id="sidebar" class="sidebar">
                        <div id="widget-area">
                            <aside class="widget widget_linklist">
                                <ul>
                                    <li><a href="Nanomonde.php" class="btn btn-gray fullwidth text-left">Présentation</a></li>
                                    <li><a href="nanoE.php" class="btn btn-gray fullwidth text-left">Enseignement</a></li>
                                    <li class="active"><a href="nanoR.php" class="btn btn-gray fullwidth text-left">Réservations</a></li>
