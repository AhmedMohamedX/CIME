                        ...
                        <main id="main">
                            ...
                            <nav class="pager">
                                <ul class="pagination">
                                    ...
                                    if ($cle>1) {?>
                                    <li><a href="news.php?cle=<?php echo $cle-1 ?>" class="page-numbers prev"><i class="fa fa-angle-double-left"></i></a></li>
                                    <?php
                                    }else{?>
                                    <li><a  class="page-numbers prev"><i class="fa fa-angle-double-left"></i></a></li>
                                    <?php
                                    }
                                    for ($i = 1; $i <= $num1; $i++) {
                                        if ($i!=$cle) {?>
                                    <li><a href="news.php?cle=<?php echo $i?>" class="page-numbers"><?php echo $i ?></a></li>
                                    <?php }else{?>
                                    <li><span class="page-numbers current"><?php echo $i ?></span></li><?php 
                                    }
                                    }
                                    if ($cle<$num1) {?>
                                    <li><a href="news.php?cle=<?php echo $cle+1 ?>" class="page-numbers next"><i class="fa fa-angle-double-right"></i></a></li>
                                    <?php 
                                    }else{?>
                                    <li><a class="page-numbers next"><i class="fa fa-angle-double-right"></i></a></li>  
                                    <?php  
                                    }
                                    ?>
                                </ul>
                    ...
                    <div id="sidebar" class="sidebar">
                        <div id="widget-area">
                            <aside class="widget widget_search">
                                <form  method="post">
                                    <div class="input-group">
                                        <input type="search" class="search-field" placeholder="Rechercher..." value="" name="s" maxlength="50" minimumlenght="3" required>
