            ...
            <div class="sub-wrapper">
                ...
                <div class="breadcrumb-container clearfix">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="obE.php">Enseignement</a></li>
                    </ul>
                </div><!-- /breadcrumb -->
            </div><!-- /sub-wrapper -->
        </div><!-- /container -->
                                   ...
                                   <?php
                                     ...
                                     ?>
                                      <h3 class="widget-title"><?php echo $nom ?></h3>
                                          ...
                                          <a href="documents/objets/<?php echo $fichier ?>" class="btn btn-download fullwidth text-left"><i class="icon icon-pdf19"></i>telechargement.pdf</a>
                        ...
                        <div id="widget-area">
                            <aside class="widget widget_linklist">
                                <ul>
                                    ...
                                    <li class="active"><a href="obE.php" class="btn btn-gray fullwidth text-left">Enseignement</a></li>
