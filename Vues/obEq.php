            ...
            <div class="sub-wrapper">
                ...
                <div class="breadcrumb-container clearfix">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="obEq.php">Equipements</a></li>
                    </ul>
                </div><!-- /breadcrumb -->
            </div><!-- /sub-wrapper -->
        </div><!-- /container -->
                            ...
                            <!-- PRODUCT LIST -->
                                ...
                                <li>
                                    <div class="product-thumb">
                                        <img src="img/equips/objets/<?php echo $photo ?>" alt="">
                        ...
                        <div id="widget-area">
                            <aside class="widget widget_linklist">
                                <ul>
                                    ...
                                    <li  class="active"><a href="obEq.php" class="btn btn-gray fullwidth text-left">Equipements</a></li>   
                                </ul>
