...
<div id="page-wrap">
    <!-- SUB HEADER -->
    <section id="sub-header" class="section bg-parallax pt-0 pb-0" data-background="img/bg/leader.jpg">
                    ...
                    <div id="content" class="site-content">
                        <main id="main">
                            <div class="page-grid">
                                ...
                                $directeur=$contact->get_directeur();
                                extract($directeur);
                                ?>
                                <!-- GRID 9 COLUMNS -->
                                <div class="page-media col-4 static">
                                    <img src="img/contacts/<?php echo $photo ?>" alt="" />
                                </div><!-- /page-media -->
                                <div class="page-content col-5">
                                    <h2><?php echo $nom ?></h2>
                                    <h2 class="section-header"><?php echo $fonction ?></h2>
                                    <p><?php echo $texte ?></p>
                                    <br />
                                    <ul class="social-list black" align='center'>
                                        <li><a href="mailto:<?php echo $mail ?>"  title='<?php echo $mail ?>' ><i class="icon icon-flickr"></i></a></li>
                                        <li><a href="<?php echo $linkedin ?>" target="blank"><i class="fa fa-linkedin"></i></a></li>
                                    </ul>
                                </div><!-- /page-content -->
                            </div><!-- /page-grid -->
                            ...
                            $contas=$contact->get_contacts();
                            if(!empty ($contas)){
                            foreach ($contas as $lines ) {
                            extract($lines);
                            ?>
                               <div class="col-sm-4 col-xs-12">
                                    <div class="team-leader">
                                        ...
                                        <h4 class="h5 text-uppercase"><?php echo $nom ?></h4>
                                        <h5><?php echo $fonction ?></h5>
                                        <p class="mb-20" data-number-line="5"><?php echo $texte ?></p>
                        ...
                        <div id="widget-area">
                            <aside class="widget widget_linklist">
                                <ul>
                                    ...
                                    <li class="active"><a href="our-leaders.php" class="btn btn-gray fullwidth text-left">Annuaire</a></li>
