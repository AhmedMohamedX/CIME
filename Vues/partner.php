...
<div id="page-wrap">
    <!-- SUB HEADER -->
    <section id="sub-header" class="section bg-parallax pt-0 pb-0" data-background="img/bg/certification.jpg">
        <div class="bg-overlay-black bg-overlay-5"></div>
        <div class="container">
            <div class="sub-wrapper">
                <h1>Partenaires</h1>
                <h2 class="h4">L’éducation est un progrès social... L’éducation est non pas une préparation à la vie, l’éducation est la vie même.</h2>
            ...
            <div class="row">
                <div class="col-md-9 col-md-push-3 col-sm-12 col-xs-12">
                    <div id="content" class="site-content">
                        <main id="main">
                            <h2 class="section-header">Partenaires locaux</h2>
                            <p>On parle peu d'eux. Et pourtant, ils sont des acteurs essentiels du centre, ces partenaires qui nous apportent chaque année leur soutien pour porter plus haut l'aventure dans le domaine de microélectronique.<br>
                            Sans eux le centre n'existerait pas. Nous les remercions avec chaleur de leur aide fondamentale.</p>
                            <br />
                            <br />
                            ...
                            ?>
                                <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 mb-30">
                                    <div class="client-logo">
                                        <a href="<?php echo $lien?>"><img src="img/client/<?php echo $logo?>" alt=""  /></a>
                                    </div><!-- /client-logo -->
                                </div><!-- /col -->
                            <?php }}?>
                            </div><!-- /row -->
                            ...
                            <h2 class="section-header">Partenaires européens</h2>
                            <p>On parle peu d'eux. Et pourtant, ils sont des acteurs essentiels du centre, ces partenaires qui nous apportent chaque année leur soutien pour porter plus haut l'aventure dans le domaine de microélectronique.<br>
                            Sans eux le centre n'existerait pas. Nous les remercions avec chaleur de leur aide fondamentale.</p>
                            <br />
                            <br />
                        ...
                        <div id="widget-area">
                            <aside class="widget widget_linklist">
                                <ul>
                                    ...
                                    <li class="active"><a href="partner.php" class="btn btn-gray fullwidth text-left">Partenaires</a></li>
