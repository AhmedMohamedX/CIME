                        ...
                        <main id="main">
                            ...
                            <div class="page-grid">
                             ...
                             <form method="post" enctype="multipart/form-data" >
                                <h2 class="section-header">ajouter un partenaire</h2>
                                <label>Type</label> 
                                <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-users"></i></span>
                                <select name="type1" style="width:300px;">
                                <option value="locaux">local</option>
                                <option value="Euro">Européen</option>
                                </select>
                                </div><br>
                                ...
                                <input type="text" class="form-control" style="width:300px;" placeholder="" autofocus name="lien1" required>
                                </div>
                                <br>
                                
                                <label>Logo</label> 
                                <div class="input-group">
                                <input type="file" class="form-control" style="width:340px;" placeholder=""   name="logo1" required>
                                </div><br>
                              ...
                              <br><br>
                               ...
                               <h2 class="section-header">liste des partenaires locaux</h2>
                                <?php
                                include'../controller/instance.part.php';
                                $l=$part->aff_parts('locaux');
                                if(!empty ($l)){
                                foreach ($l as $lines ) {
                                    extract($lines);
                                ?>
                                    <li>
                                <?php echo $lien?> <br><br>
                                <img src="img/client/<?php echo $logo ?>" height="90" width="120" align="left"> <br> <br> <br><br>
                                <a href="?cle=<?php echo $id   ?>" onClick="if(!confirm('voulez vous supprimer ce partenaire?')) return false">supprimer</a> <a href="modifpart.php?m=<?php echo $id  ?>">modifier</a>
                                <br><br>
                                <?php } }
                                ?><br>
                                <h2 class="section-header">liste des partenaires européens</h2>
                                <?php
                                $l=$part->aff_parts('euro');
                                if(!empty ($l)){
                                foreach ($l as $lines ) {
                                    extract($lines);
                                ?>
                                ...
                                if(isset($_GET['cle'])){
                                if($part->supp_part($_GET['cle'])){
                                    $fichier = 'img/client/'.$logo;
                                    unlink( $fichier ); 
                                ...
                                if(isset($_POST['ajt'])){
                                if($part->ajt_part($_POST['type1'],$_POST['lien1'],$_FILES['logo1']['name'])){
                                copy($_FILES['logo1']['tmp_name'],'img/client/'.$_FILES['logo1']['name']);
                                header("location:parts.php");
                                    }
                                    else
                        ...
                        <div id="widget-area">
                            <aside class="widget widget_linklist">
                                <ul>
                                    ...
                                    <li  class="active"><a href="parts.php" class="btn btn-gray fullwidth text-left">Partenaires</a></li> 
