                        ...
                        <main id="main">
                            ...
                            <div class="page-grid">
                              ...
                              <form method="post" enctype="multipart/form-data" >
                                <!-- GRID 9 COLUMNS -->
                                <h2 class="section-header">ajouter un equipement</h2>
                                <label>Nom</label> 
                                ...
                                <input type="text" class="form-control" style="width:300px;" placeholder="" autofocus  name="version1" required>
                                </div><br>
                              ...
                              <br><br>
                                ...
                                if(isset($_POST['ajt'])){
                                if($equip->ajt_equip($_POST['nom1'],$_POST['version1'],$_POST['plat1'],$_FILES['photo1']['name'])){ 
                                    if ($_POST['plat1']=='conception') {
                                copy($_FILES['photo1']['tmp_name'],'img/equips/conception/'.$_FILES['photo1']['name']);
                                    }
                                    if ($_POST['plat1']=='SB') {
                                copy($_FILES['photo1']['tmp_name'],'img/equips/SB/'.$_FILES['photo1']['name']);
                                    }
                                    if ($_POST['plat1']=='micro') {
                                copy($_FILES['photo1']['tmp_name'],'img/equips/micro/'.$_FILES['photo1']['name']);
                                    }
                                    if ($_POST['plat1']=='carac') {
                                copy($_FILES['photo1']['tmp_name'],'img/equips/carac/'.$_FILES['photo1']['name']);
                                    }
                                    if ($_POST['plat1']=='ob') {
                                copy($_FILES['photo1']['tmp_name'],'img/equips/objets/'.$_FILES['photo1']['name']);
                                    }
                                    if ($_POST['plat1']=='nano') {
                                copy($_FILES['photo1']['tmp_name'],'img/equips/nano/'.$_FILES['photo1']['name']);
                                    }
                                    if ($_POST['plat1']=='bio') {
                                copy($_FILES['photo1']['tmp_name'],'img/equips/bio/'.$_FILES['photo1']['name']);
                                    }
                                    if ($_POST['plat1']=='hyper') {
                                copy($_FILES['photo1']['tmp_name'],'img/equips/hyper/'.$_FILES['photo1']['name']);
                                ...
                                header("location:plats.php");
                                     ...
                                     ?>
                                <h2 class="section-header">Liste des equipements plateforme conception</h2>
                                <?php
                                $equips=$equip->get_equips('conception');
                                if(!empty ($equips)){
                                ...
                                <a href="?cle=<?php echo $id   ?>" onClick="if(!confirm('voulez vous supprimer cet equipement?')) return false">supprimer</a> <a href="modifequip.php?m=<?php echo $id  ?>">modifier</a>
                                </li><?php
                                if(isset($_GET['cle'])){
                                if($equip->supp_equip($_GET['cle'])){
                                header("location:plats.php");
                                }
                                }
                                } }
                                ?><br>
                                <h2 class="section-header">Liste des equipements plateforme salle blanche</h2>
                                <?php
                                $equips=$equip->get_equips('SB');
                                if(!empty ($equips)){
                                foreach ($equips as $lines ) {
                                extract($lines);
                                ?><li><?php
                                ...
                                ?><br>
                                <h2 class="section-header">Liste des equipements plateforme Microsystèmes et capteurs</h2>
                                <?php
                                $equips=$equip->get_equips('micro');
                                if(!empty ($equips)){
                                foreach ($equips as $lines ) {
                                extract($lines);
                                ?><li><?php
                                ...
                                ?><br>
                                <h2 class="section-header">Liste des equipements plateforme Caractérisation électrique</h2>
                                <?php
                                $equips=$equip->get_equips('carac');
                                if(!empty ($equips)){
                                foreach ($equips as $lines ) {
                                extract($lines);
                                ?><li><?php
                                ...
                                ?><br>
                                <h2 class="section-header">Liste des equipements plateforme Objets communicants</h2>
                                <?php
                                $equips=$equip->get_equips('ob');
                                if(!empty ($equips)){
                                foreach ($equips as $lines ) {
                                extract($lines);
                                ?><li><?php
                                ...
                                ?><br>
                                <h2 class="section-header">Liste des equipements plateforme nanomonde</h2>
                                <?php
                                $equips=$equip->get_equips('nano');
                                if(!empty ($equips)){
                                foreach ($equips as $lines ) {
                                extract($lines);
                                ?><li><?php
                                ...
                                ?><br>
                                <h2 class="section-header">Liste des equipements plateforme biotechnologies</h2>
                                <?php
                                $equips=$equip->get_equips('bio');
                                if(!empty ($equips)){
                                foreach ($equips as $lines ) {
                                extract($lines);
                                ?><li><?php
                                ...
                                ?><br>
                                <h2 class="section-header">Liste des equipements plateforme Hyperfréquence et optique guidée</h2>
                                <?php
                                $equips=$equip->get_equips('hyper');
                                if(!empty ($equips)){
                                foreach ($equips as $lines ) {
                                extract($lines);
                                ?><li><?php
