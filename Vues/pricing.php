                   ...
                   <li><a href="index.php">Accueil</a></li>
                    ...
                    <li class="menu-item-has-children">
                        ...
                        <ul class="sub-menu">
                            ...
                            <li><a href="Microsystèmes.php">Microsystèmes et capteurs</a></li>
                            <li><a href="Caractérisation.php">Caractérisation électrique</a></li>
                            ...
                            <li><a href="Hyperfréquence.php">Hyperfréquence et optique guidée</a></li>
                        </ul>
                    </li>
...
<div id="page-wrap">
    <!-- SUB HEADER -->
    <section id="sub-header" class="section bg-parallax pt-0 pb-0" data-background="img/bg/pricing.jpg">
        <div class="bg-overlay-black bg-overlay-5"></div>
        <div class="container">
            <div class="sub-wrapper">
                <h1>Les Tarifs</h1>
                <h2 class="h4">Les vraies études sont celles qui apprennent les choses utiles à la vie humaine.</h2>
            ...
            <div class="row">
                <div class="col-md-9 col-md-push-3 col-sm-12 col-xs-12">
                    <div id="content" class="site-content">
                        <main id="main">
                            <h2 class="section-header">Tarifs Recherche</h2>

                            <!-- STYLE 1 -->
                            <div class="row m0">
                                <div class="col-lg-4 col-sm-6 col-xs-12 pd0">
                                    <div class="pricing-element">
                                        <div class="pricing-header">OCAE</div><!-- /pricing-header -->
                                        <?php
                                        include'../controller/instance.tarif.php';
                                        $val=$tarif->aff_tarif('OCAE','Recherche');
                                        extract($val);
                                        ?>

                                        <div class="pricing-body">
                                            <ul>
                                                <li><span><?php echo $nbrsalles ?></span> Salles</li>
                                                <li><span><?php echo $nbrprojets ?></span> Projets</li>
                                                <li><span><?php echo $nbrenseignants ?></span> Enseignants</li>
                                                <li><span><?php echo $nbrheures ?></span> Heures</li>
                                            </ul>
                                            <div class="price"><?php echo $tarif ?></div><!-- /price -->
                                        </div><!-- /pricing-body -->

                                        <div class="pricing-footer">
                                            <button type="button" class="btn btn-primary radius" onclick="self.location.href='contact.php'">S'inscrire</button>
                                        </div><!-- /pricing-footer -->
                                    </div><!-- /pricing-element -->
                                </div><!-- /col -->

                                <div class="col-lg-4 col-sm-6 col-xs-12 pd0">
                                    <div class="pricing-element impress">
                                        <div class="pricing-header">HOG</div><!-- /pricing-header -->
                                        <?php
                                        $tar1= new tarifs();
                                        $val1=$tar1->aff_tarif('HOG','Recherche');
                                        extract($val1);
                                        ?>
                                ...
                                <div class="col-lg-4 col-sm-12 col-xs-12 pd0">
                                    <div class="pricing-element">
                                        <div class="pricing-header">SB</div><!-- /pricing-header -->
                                        <?php
                                        $tar2= new tarifs();
                                        $val2=$tar2->aff_tarif('SB','Recherche');
                                        extract($val2);
                                        ?>
                                        <div class="pricing-body">
                                            <ul>
                            ...
                            <h2 class="section-header">Tarifs Exterieurs</h2>
                            ...
                            <div class="row m0">
                                <div class="col-lg-4 col-sm-6 col-xs-12 pd0">
                                    <div class="pricing-element">
                                        ...
                                        <?php
                                        $tar3= new tarifs();
                                        $val3=$tar3->aff_tarif('OCAE','exterieurs');
                                        extract($val3);
                                        ?>
                                        <div class="pricing-body">
                                            <ul>
                                ...
                                <div class="col-lg-4 col-sm-6 col-xs-12 pd0">
                                    <div class="pricing-element impress">
                                        ...
                                        <?php
                                        $tar4= new tarifs();
                                        $val4=$tar4->aff_tarif('HOG','exterieurs');
                                        extract($val4);
                                        ?>
                                        <div class="pricing-body">
                                            <ul>
                                ...
                                <div class="col-lg-4 col-sm-12 col-xs-12 pd0">
                                    <div class="pricing-element">
                                        ...
                                        <?php
                                        $tar5= new tarifs();
                                        $val5=$tar5->aff_tarif('SB','exterieurs');
                                        extract($val5);
                                        ?>
                                        <div class="pricing-body">
                                            <ul>
                        ...
                        <div id="widget-area">
                            <aside class="widget widget_linklist">
                                <ul>
                                    ...
                                    <li class="active"><a href="pricing.php" class="btn btn-gray fullwidth text-left">Tarifs</a></li>
                                </ul>
