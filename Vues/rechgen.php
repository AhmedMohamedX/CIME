    ...
    <section class="section bg-white pt-70 pb-60">
        <div class="container">
                        ...
                        <main id="main">
                            ...
                            if(!empty ($actuas)){
                            ?> <h2 class="section-header">Résultats de recherche dans actualités </h2> <?php
                            ...
                            $chifs=$chiffre->recherche($rech);
                            if(!empty ($chifs)){
                            ?> <h2 class="section-header">Résultats de recherche dans chiffres </h2> <?php
                            foreach ($chifs as $chifs ) {
                            extract($chifs);
                            ?>
                                    <h3>Type de chiffre :</h3><?php echo $type ?>
                                    <br><h3>Valeur :</h3><?php echo $valeur ?>  <br>
                                    <div class="divider pt-30 pb-40"></div>
                            ...
                            $conts=$contact->recherche($rech);
                            if(!empty ($conts)){
                            ?> <h2 class="section-header">Résultats de recherche dans contacts </h2> <?php
                            foreach ($conts as $conts ) {
                            extract($conts);
                            ?>
                                    <h3>Nom :</h3><?php echo $nom ?>  <br>
                                    <br><h3>Fonction :</h3><?php echo $fonction ?>  <br>
                                    <br><h3>E-mail :</h3><?php echo $mail ?>  <br>
                                    <div class="divider pt-30 pb-40"></div>
                            ...
                            $docs=$doc->recherche($rech);
                            if(!empty ($docs)){
                            ?> <h2 class="section-header">Résultats de recherche dans documents </h2> <?php
                            foreach ($docs as $docs ) {
                            extract($docs);
                            ?>
                                    <h3>Nom :</h3><?php echo $nom ?>  <br>
                                    <br><h3>Plateforme :</h3><?php echo $plateforme ?>  <br>
                                    <br><h3>Fichier :</h3><a href="documents/bio/<?php echo $fichier ?>"><?php echo $fichier ?></a>  <br> <br>
                                    <div class="divider pt-30 pb-40"></div>
                            ...
                            $equips=$equip->recherche($rech);
                            if(!empty ($equips)){
                            ?> <h2 class="section-header">Résultats de recherche dans les equipements </h2> <?php
                            foreach ($equips as $equips ) {
                            extract($equips);
                            ?>
                                    <h3>Nom :</h3><?php echo $nom ?>  <br>
                                    <br><h3>Plateforme :</h3><?php echo $plateforme ?>  <br>
                                    <?php if($plateforme!='ob'){ ?>
                                    <br><h3>Fichier :</h3><a href="documents/<?php echo $plateforme ?>/<?php echo $fichier ?>"><?php echo $fichier ?></a>  <br> <br>
                                    <?php } ?>
                                    <?php if($plateforme=='ob'){ ?>
                                    <br><h3>Fichier :</h3><a href="documents/objets/<?php echo $fichier ?>"><?php echo $fichier ?></a>  <br> <br>
                                    <?php } ?>
                                    <div class="divider pt-30 pb-40"></div>
                            ...
                            <?php }}
                                ?>
                                                            ...
                                                            <?php
                            include'../controller/instance.faq.php';

                            $faqs=$faq->recherche($rech);
                            if(!empty ($faqs)){
                            ?> <h2 class="section-header">Résultats de recherche dans les FAQ </h2> <?php
                            foreach ($faqs as $faqs ) {
                            extract($faqs);
                            ?>
                                    <h3>Question :</h3><?php echo $question ?>  <br>
                                    <br><h3>Réponse :</h3><?php echo $reponse ?>  <br>
                                    <div class="divider pt-30 pb-40"></div>
                            ...
                            $plans=$plan->recherche($rech);
                            if(!empty ($plans)){
                            ?> <h2 class="section-header">Résultats de recherche dans les plannings </h2> <?php
                            ...
                            ?>
                                    ...
                                    <br><h3>Plateforme :</h3><?php echo $plateforme ?>  <br>
                                    <?php if($plateforme!='ob'){ ?>
                                    <br><h3>Fichier :</h3><a href="plannings/<?php echo $plateforme ?>/<?php echo $fichier ?>"><?php echo $fichier ?></a>  <br> <br>
                                    <?php } ?>
                                    <?php if($plateforme=='ob'){ ?>
                                    <br><h3>Fichier :</h3><a href="plannings/objets/<?php echo $fichier ?>"><?php echo $fichier ?></a>  <br> <br>
                                    <?php } ?>
                                    <div class="divider pt-30 pb-40"></div>


                            <?php }}
                            if ((empty($actuas)) && (empty($chifs)) && (empty($conts)) && (empty($docs)) && (empty($equips)) && (empty($faqs)) && (empty($plans)) ) {
