                        ...
                        <main id="main">
                            ...
                            <div class="page-grid">
                              ...
                              <form method="post" enctype="multipart/form-data" >
                               ...
                               if(isset($_POST['res'])){
                               $res->ajt_res($_POST['ecole'],$_POST['annee'],$_POST['option'],$_POST['plat'],$_POST['nbre'],$_POST['intitu'],$_POST['dated'],$_POST['datef'],$_POST['tranche'],$_POST['encadre'],$_POST['encadrer'],$_POST['complete'],$_POST['completer'],$_SESSION['login'],date('Y-m-d'),'2');  
                        ...
                        <div id="widget-area">
                            <aside class="widget widget_linklist">
                                <ul>
                                    ...
                                    <li> &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;<font color="#1959A6"><a href="res.php" >Reserver</a></font></li>
                                    <li> &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;<a href="listeres4.php" >Liste des demandes</a></li>
