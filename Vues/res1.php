                        ...
                        <main id="main">
                            ...
                            <div class="page-grid">
                              ...
                              <form method="post" enctype="multipart/form-data" >
                               ...
                               $res->ajt_res($_POST['ecole'],$_POST['annee'],$_POST['option'],$plat2,$_POST['nbre'],$_POST['intitu'],$_POST['dated'],$_POST['datef'],$_POST['tranche'],$_POST['encadre'],$_POST['encadrer'],$_POST['complete'],$_POST['completer'],$_SESSION['login'],date('Y-m-d'),'2');  
                        ...
                        <div id="widget-area">
                            <aside class="widget widget_linklist">
                                <ul>
                                    ...
                                    <li> &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;<font color="#1959A6"><a href="res1.php" >Reserver</a></font></li>
                                    <li> &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;<a href="listeres1.php" >Liste des demandes</a></li>
