                        ...
                        <main id="main">
                            ...
                            <div class="page-grid">
                              ...
                              <form method="post" enctype="multipart/form-data" >
                                <!-- GRID 9 COLUMNS -->
                                <h2 class="section-header">Fiche de réservation</h2>
                                <label>Ecole ou université</label> 
                                <div class="input-group">
                                <input type="text" class="form-control" style="width:350px;" placeholder="" autofocus name="ecole" required>
                                </div>
                                <br>
                                <label>Année d’études</label> 
                                <div class="input-group">
                                <input type="text" class="form-control" style="width:350px;" placeholder="" autofocus name="annee" required>
                                </div>
                                <br>
                                <label>Option ou spécialité</label> 
                                <div class="input-group">
                                <input type="text" class="form-control" style="width:350px;" placeholder="" autofocus name="option" required>
                                </div>
                                <br>
                                <label>Plateforme utilisée</label> 
                                <div class="input-group">
                                <select name="plat" style="width:350px;">
                                ...
                                <label>Nombre d’étudiants au total dans le TP</label> 
                                <div class="input-group">
                                <input type="number" class="form-control" style="width:350px;" placeholder="" min="1" max="20" autofocus name="nbre" required>
                                </div>
                                <br>
                                <label>Intitulé des travaux pratiques ou projet</label> 
                                <div class="input-group">
                                <input type="text" class="form-control" style="width:350px;" placeholder="" autofocus name="intitu" required>
                                </div>
                                <br>
                                <label>Date de début des TP</label> 
                                <div class="input-group">
                                <input type="date" class="form-control" style="width:350px;" placeholder="" autofocus name="dated" required>
                                </div>
                                <br>
                                <label>Date de fin des TP</label> 
                                <div class="input-group">
                                <input type="date" class="form-control" style="width:350px;" placeholder="" autofocus name="datef" required>
                                </div>
                                <br>
                                <label>Tranches horaires dans la semaine</label> 
                                <div class="input-group">
                                <input type="text" class="form-control" style="width:350px;" placeholder="" autofocus name="tranche" required>
                                </div>
                                <br>
                                <label>Les étudiants travaillent-ils en dehors des séances encadrées ?</label> 
                                <div class="input-group">
                                <select name="encadre" style="width:350px;">
                                <option value="oui">Oui</option>
                                <option value="non">Non</option>
                                </select>
                                </div><br>
                                <label>Si oui, estimation du nombre d’heures par étudiant</label> 
                                <div class="input-group">
                                <input type="text" class="form-control" style="width:350px;" placeholder="" autofocus name="encadrer" >
                                </div>
                                <br>
                                <label>Le TP conduit-il à la conception complète d’un circuit intégré ?</label> 
                                <div class="input-group">
                                <select name="complete" style="width:350px;">
                                <option value="oui">Oui</option>
                                <option value="non">Non</option>
                                </select>
                                </div><br>
                                <label>Si, oui, de quel type</label> 
                                <div class="input-group">
                                <select name="completer" style="width:350px;">
                                <option value=""></option>
                                <option value="cmp">CMP</option>
                                <option value="Euro-practice">Euro-practice</option>
                                <option value="autre">Autre</option>
                                </select>
                                </div><br>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button type="submit" name="res" class="btn btn-primary">Envoyer</button>
                               ...
                               if(isset($_POST['res'])){
                               $res->ajt_res($_POST['ecole'],$_POST['annee'],$_POST['option'],$_POST['plat'],$_POST['nbre'],$_POST['intitu'],$_POST['dated'],$_POST['datef'],$_POST['tranche'],$_POST['encadre'],$_POST['encadrer'],$_POST['complete'],$_POST['completer'],$_SESSION['login'],date('Y-m-d'),'1');  
                        ...
                        <div id="widget-area">
                            <aside class="widget widget_linklist">
                                <ul>
                                    ...
                                    <li  class="active"><a href="res1.php" class="btn btn-gray fullwidth text-left">Réservations</a></li>
                                    <li> &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;<font color="#1959A6"><a href="res3.php" >Reserver</a></font></li>
                                    <li> &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;<a href="listeres3.php" >Mes demandes</a></li>
                                    <li><a href="cong2.php" class="btn btn-gray fullwidth text-left">Congés</a></li>
