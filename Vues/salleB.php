...
<head>
    ...
    <title>CIME | Salle Blanche</title>
</head>
            ...
            <div class="sub-wrapper">
                ...
                <div class="breadcrumb-container clearfix">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li>Salle Blanche</li>
                        <li><a href="salleB.php">Présentation</a></li>
                    </ul>
                </div><!-- /breadcrumb -->
            </div><!-- /sub-wrapper -->
        </div><!-- /container -->
            ...
            <div class="row">
                <div class="col-md-9 col-md-push-3 col-sm-12 col-xs-12">
                    <div id="content" class="site-content">
                        <main id="main">
                            <h2 class="section-header">Salle Blanche</h2>
                            <div class="work-slider mb-20">
                                <img src="img/work/sb1.jpg" alt="" />
                                <img src="img/work/sb2.jpg" alt="" />
                                <img src="img/work/sb3.jpg" alt="" />
                                <img src="img/work/sb4.jpg" alt="" />
                                <img src="img/work/sb5.jpg" alt="" />
                            </div><!-- /work-slider -->

                            <div class="work-item-slider-wrapper">
                                <div class="work-item-slider">
                                    <a href="#"><img src="img/work/thumb/sb1.jpg" alt="" /></a>
                                    <a href="#"><img src="img/work/thumb/sb2.jpg" alt="" /></a>
                                    <a href="#"><img src="img/work/thumb/sb3.jpg" alt="" /></a>
                                    <a href="#"><img src="img/work/thumb/sb4.jpg" alt="" /></a>
                                    <a href="#"><img src="img/work/thumb/sb5.jpg" alt="" /></a>
                                </div><!-- /work-slider -->
                            ...
                            <div class="page-grid">
                                ...
                                <div class="page-content col-8">
                                    ...
                                    <p>La plateforme salle blanche s’étend sur une surface de 750 m2 de classe 1000 et 100. Elle regroupe différents modules technologiques destinés à l’élaboration de circuits et de microsystèmes intégrés (implantation, traitement thermique, dépôts de couches minces, photolithographie, gravure profonde…).</p>
                                    <br />
                                    <p>La salle blanche du CIME Nanotech est issue de la création du CIME en 1981, par décision conjointe de l’INP Grenoble et de l’Université Joseph Fourier. L’objectif à cette époque était d’offrir aux élèves-ingénieurs et étudiants une formation pratique dans le domaine en plein essor de la fabrication de circuits intégrés, au sein d'un centre inter-universitaire. Si la mission principale reste la même,l'offre se diversifie aussi, par exemple avec l’élaboration de microsystèmes intégrés, de cellules photovoltaïques.</p>
                                </div><!-- /page-content -->    
                            </div><!-- /page-grid -->
                        </main>
                    </div><!-- /site-content -->
                    ...
                    <div id="sidebar" class="sidebar">
                        <div id="widget-area">
                            <aside class="widget widget_linklist">
                                <ul>
                                    <li class="active"><a href="salleB.php" class="btn btn-gray fullwidth text-left">Présentation</a></li>
                                    <li><a href="salleE.php" class="btn btn-gray fullwidth text-left">Enseignement</a></li>
                                    <li><a href="salleR.php" class="btn btn-gray fullwidth text-left">Réservations</a></li>
                                    <li><a href="salleP.php" class="btn btn-gray fullwidth text-left">Plannings</a></li>
                                    <li><a href="salleEq.php" class="btn btn-gray fullwidth text-left">Equipements</a></li>   
                                </ul>
