            ...
            <div class="sub-wrapper">
                ...
                <div class="breadcrumb-container clearfix">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li>Salle Blanche</li>
                        <li><a href="salleEq.php">Equipements</a></li>
                    </ul>
                </div><!-- /breadcrumb -->
            </div><!-- /sub-wrapper -->
        </div><!-- /container -->
                            ...
                            <ul class="product clearfix mt-30">
                                ...
                                <li>
                                    <div class="product-thumb">
                                        <img src="img/equips/SB/<?php echo $photo ?>" alt="">
                        ...
                        <div id="widget-area">
                            <aside class="widget widget_linklist">
                                <ul>
                                    ...
                                    <li  class="active"><a href="salleEq.php" class="btn btn-gray fullwidth text-left">Equipements</a></li>   
                                </ul>
