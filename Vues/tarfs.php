                ...
                <div class="col-md-9 col-md-push-3 col-sm-12 col-xs-12">
                    <div id="content" class="site-content">
                        <main id="main">
                            ...
                            <div class="page-grid">
                                <h2 class="section-header">liste des tarifs</h2>
                                <?php
                                ...
                                ?>
                                    <li>
                                <?php echo $nom?> pour <?php echo $type ?><br><br>
                                Nombre de salles: <?php echo $nbrsalles?><br>
                                Nombre des heures: <?php echo $nbrheures?><br>
                                Nombre de projets: <?php echo $nbrprojets?><br>
                                Nombre des enseignatns: <?php echo $nbrenseignants?><br>
                                Tarif: <?php echo $tarif?><br>
                                <a href="modiftarf.php?m=<?php echo $id  ?>">modifier</a>
                                <br><br>
                                <?php } }
