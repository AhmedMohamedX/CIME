                        ...
                        <main id="main">
                            ...
                            <div class="page-grid">
                              ...
                              <form method="post" enctype="multipart/form-data" >
                                <h2 class="section-header">ajouter un témoignage</h2>
                                <label>Nom</label> 
                              ...
                              <?php 
                                ...
                                if(isset($_POST['ajt'])){
                                    if($tem->ajt_tem($_POST['nom1'],$_POST['fonction1'],$_POST['texte1'],$_FILES['photo1']['name'])){
                               ...
                               <h2 class="section-header">liste des témoignages</h2><br>
                                
                                <?php
                                $conts=$tem->get_temoig();
                                if(!empty ($conts)){
                                ...
                                Texte: <?php echo substr($texte, 0, 100) ?>.....<br>  <a href="?cle=<?php echo $id   ?>" onClick="if(!confirm('voulez vous supprimer ce témoignage?')) return false">supprimer</a> <a href="modiftem.php?m=<?php echo $id  ?>">modifier</a>
                                <br><br>
                                <?php }
                                if(isset($_GET['cle'])){
                                if($tem->supp_tem($_GET['cle'])){
