                        ...
                        <main id="main"> 
                            ...
                            <div class="page-grid" >
                              <form method="post" enctype="multipart/form-data"  >
                                <!-- GRID 9 COLUMNS -->
                                <h2 class="section-header">Ajouter un utilisateur</h2>
                                <label>Login</label> 
                                <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-users"></i></span>
                                <input type="text" class="form-control" style="width:300px;" placeholder="" autofocus name="login1"  >
                                </div>
                                <br>
                                <label>Fonction</label> 
                                <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-users"></i></span>
                                <select name="type1" style="width:300px;">
                                ...
                                <input type="text" class="form-control" style="width:300px;" placeholder="" autofocus  name="mdp1">
                                </div><br>
                                <label>Retaper le mot de passe</label> 
                                <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-shield"></i></span>
                                <input type="text" class="form-control" style="width:300px;" placeholder="" autofocus  name="mdp2">
                                </div>
                                <br>
                                <button type="submit" name="ajt" class="btn btn-primary">ajouter utilisateur</button>
                                </form>
                               <?php
                               include'../controller/instance.user.php';
                               if(isset($_POST['ajt'])){
                                ?><br><?php 
                                if($user->exist_user($_POST['login1'])==false){?>
                               ...
                               if(empty($_POST['login1'])){?>
                                ...
                                <div class="alert alert-error alert-dismissible mb-30" style="width:350px;">
                                <i class="fa fa-times-circle"></i><span class="alert-title">Erreur!</span> Taper le login
                                </div><!-- /alert -->
                               <?php
                               }
                               if(empty($_POST['mdp1'])){?>
                                ...
                                <div class="alert alert-error alert-dismissible mb-30" style="width:350px;">
                                <i class="fa fa-times-circle"></i><span class="alert-title">Erreur!</span> Taper le mot de passe
                                </div><!-- /alert -->
                               <?php
                               }
                               if(empty($_POST['mdp2']) && (!empty($_POST['Nmdp1']))){?>
                               
                                <div class="alert alert-error alert-dismissible mb-30" style="width:350px;">
                                <i class="fa fa-times-circle"></i><span class="alert-title">Erreur!</span> Retaper le mot de passe
                                </div><!-- /alert -->
                               <?php
                               }
                               ...
                               if($user->exist_user($_POST['login1'])){
                               if ( (!empty($_POST['login1'])) && (!empty($_POST['mdp1'])) && (!empty($_POST['mdp2'])) && ($_POST['mdp1']==$_POST['mdp2'])  ) {
                               if($user->ajt_user($_POST['login1'],$_POST['mdp1'],$_POST['type1']) ){?>
                               <br>
                                <div class="alert alert-success alert-dismissible mb-30" style="width:350px;">
                                <i class="fa fa-check"></i><span class="alert-title">succès!</span> succès d'ajout.
                                </div><!-- /alert --><?php
                               
                                 }else{?>

                                <div class="alert alert-error alert-dismissible mb-30" style="width:350px;">
                                <i class="fa fa-times-circle"></i><span class="alert-title">Erreur!</span> Echec d'ajout.
                                </div><!-- /alert -->
                                <?php
                                 }
                                }
                                ...
                                if(!empty ($users)){
                                foreach ($users as $lines ) {
                                    extract($lines);
                                ?>
                                    <li>
                                Login: <?php echo $login?> <br>
                                Mot de passe: <?php echo $motdepasse?><br>
                                Fonction :<?php echo $type ?><br> <a href="?cle=<?php echo $login   ?>" onClick="if(!confirm('voulez vous supprimer cet utilisateur?')) return false">supprimer</a> <a href="modif.php?m=<?php echo $login  ?>">modifier</a>
                                <br><br>
                                <?php }
                                if(isset($_GET['cle'])){
                                if($user->supp_user($_GET['cle'])){
