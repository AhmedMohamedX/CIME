...
<div id="page-wrap">
    <!-- SUB HEADER -->
    <section id="sub-header" class="section bg-parallax pt-0 pb-0" data-background="img/bg/work.jpg">
        <div class="bg-overlay-black bg-overlay-5"></div>
        <div class="container">
            <div class="sub-wrapper">
                <h1>Plateformes</h1>
                <h2 class="h4">L'humanité est un sentiment réfléchi, l'éducation seule le développe et le fortifie.</h2>
    ...
    <!-- PORTFOLIO 1 -->
    <section class="section pt-60 pb-60 bg-white">
        <div class="container">
            <h2 class="section-header big" data-section-center="991">Plateformes</h2>
            <!-- FILTER -->
            <ul class="portfolio-selector filters">
